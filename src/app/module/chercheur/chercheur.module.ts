...
import { ImpotChercheurModule } from './view/impot/impot-chercheur.module';
import { ImpotChercheurRoutingModule } from './view/impot/impot-chercheur-routing.module';
...
@NgModule({
    ...
    imports: [
        ...
        BadgeModule,
        MultiSelectModule,
        ImpotChercheurModule,
        ImpotChercheurRoutingModule,
    ],
    exports: [
        LoginChercheurComponent,
        RegisterChercheurComponent,
