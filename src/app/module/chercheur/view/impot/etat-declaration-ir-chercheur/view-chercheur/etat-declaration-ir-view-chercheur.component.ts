...
@Component({
  selector: 'app-etat-declaration-ir-view-chercheur',
  templateUrl: './etat-declaration-ir-view-chercheur.component.html',
  styleUrls: ['./etat-declaration-ir-view-chercheur.component.css']
})
export class EtatDeclarationIrViewChercheurComponent implements OnInit {
