...
@Component({
  selector: 'app-etat-declaration-ir-edit-chercheur',
  templateUrl: './etat-declaration-ir-edit-chercheur.component.html',
  styleUrls: ['./etat-declaration-ir-edit-chercheur.component.css']
})
export class EtatDeclarationIrEditChercheurComponent implements OnInit {
