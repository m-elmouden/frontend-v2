...
@Component({
  selector: 'app-etat-declaration-ir-create-chercheur',
  templateUrl: './etat-declaration-ir-create-chercheur.component.html',
  styleUrls: ['./etat-declaration-ir-create-chercheur.component.css']
})
export class EtatDeclarationIrCreateChercheurComponent implements OnInit {
