...
@Component({
  selector: 'app-etat-declaration-ir-list-chercheur',
  templateUrl: './etat-declaration-ir-list-chercheur.component.html',
  styleUrls: ['./etat-declaration-ir-list-chercheur.component.css']
})
export class EtatDeclarationIrListChercheurComponent implements OnInit {
   // declarations
