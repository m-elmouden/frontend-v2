...
@Component({
  selector: 'app-taux-is-create-chercheur',
  templateUrl: './taux-is-create-chercheur.component.html',
  styleUrls: ['./taux-is-create-chercheur.component.css']
})
export class TauxIsCreateChercheurComponent implements OnInit {
