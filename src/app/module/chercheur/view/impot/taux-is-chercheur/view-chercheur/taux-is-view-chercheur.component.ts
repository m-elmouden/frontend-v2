...
@Component({
  selector: 'app-taux-is-view-chercheur',
  templateUrl: './taux-is-view-chercheur.component.html',
  styleUrls: ['./taux-is-view-chercheur.component.css']
})
export class TauxIsViewChercheurComponent implements OnInit {
