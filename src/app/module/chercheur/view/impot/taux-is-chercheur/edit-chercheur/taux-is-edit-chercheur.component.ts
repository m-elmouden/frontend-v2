...
@Component({
  selector: 'app-taux-is-edit-chercheur',
  templateUrl: './taux-is-edit-chercheur.component.html',
  styleUrls: ['./taux-is-edit-chercheur.component.css']
})
export class TauxIsEditChercheurComponent implements OnInit {
