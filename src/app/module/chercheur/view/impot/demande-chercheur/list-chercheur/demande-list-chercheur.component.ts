...
@Component({
  selector: 'app-demande-list-chercheur',
  templateUrl: './demande-list-chercheur.component.html',
  styleUrls: ['./demande-list-chercheur.component.css']
})
export class DemandeListChercheurComponent implements OnInit {
   // declarations
