...
@Component({
  selector: 'app-demande-view-chercheur',
  templateUrl: './demande-view-chercheur.component.html',
  styleUrls: ['./demande-view-chercheur.component.css']
})
export class DemandeViewChercheurComponent implements OnInit {
