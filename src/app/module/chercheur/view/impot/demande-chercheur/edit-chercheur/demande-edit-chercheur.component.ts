...
@Component({
  selector: 'app-demande-edit-chercheur',
  templateUrl: './demande-edit-chercheur.component.html',
  styleUrls: ['./demande-edit-chercheur.component.css']
})
export class DemandeEditChercheurComponent implements OnInit {
