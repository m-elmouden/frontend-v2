...
@Component({
  selector: 'app-societe-edit-chercheur',
  templateUrl: './societe-edit-chercheur.component.html',
  styleUrls: ['./societe-edit-chercheur.component.css']
})
export class SocieteEditChercheurComponent implements OnInit {
