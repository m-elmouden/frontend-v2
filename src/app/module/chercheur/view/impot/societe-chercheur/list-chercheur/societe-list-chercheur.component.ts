...
@Component({
  selector: 'app-societe-list-chercheur',
  templateUrl: './societe-list-chercheur.component.html',
  styleUrls: ['./societe-list-chercheur.component.css']
})
export class SocieteListChercheurComponent implements OnInit {
   // declarations
