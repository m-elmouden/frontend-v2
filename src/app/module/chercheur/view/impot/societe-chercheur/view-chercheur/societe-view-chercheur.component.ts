...
@Component({
  selector: 'app-societe-view-chercheur',
  templateUrl: './societe-view-chercheur.component.html',
  styleUrls: ['./societe-view-chercheur.component.css']
})
export class SocieteViewChercheurComponent implements OnInit {
