...
@Component({
  selector: 'app-compte-comptable-view-chercheur',
  templateUrl: './compte-comptable-view-chercheur.component.html',
  styleUrls: ['./compte-comptable-view-chercheur.component.css']
})
export class CompteComptableViewChercheurComponent implements OnInit {
