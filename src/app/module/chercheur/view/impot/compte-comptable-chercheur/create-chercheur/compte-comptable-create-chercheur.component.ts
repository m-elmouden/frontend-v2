...
@Component({
  selector: 'app-compte-comptable-create-chercheur',
  templateUrl: './compte-comptable-create-chercheur.component.html',
  styleUrls: ['./compte-comptable-create-chercheur.component.css']
})
export class CompteComptableCreateChercheurComponent implements OnInit {
