...
@Component({
  selector: 'app-compte-comptable-edit-chercheur',
  templateUrl: './compte-comptable-edit-chercheur.component.html',
  styleUrls: ['./compte-comptable-edit-chercheur.component.css']
})
export class CompteComptableEditChercheurComponent implements OnInit {
