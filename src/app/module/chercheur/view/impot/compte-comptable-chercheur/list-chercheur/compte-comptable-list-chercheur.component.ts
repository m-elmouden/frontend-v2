...
@Component({
  selector: 'app-compte-comptable-list-chercheur',
  templateUrl: './compte-comptable-list-chercheur.component.html',
  styleUrls: ['./compte-comptable-list-chercheur.component.css']
})
export class CompteComptableListChercheurComponent implements OnInit {
   // declarations
