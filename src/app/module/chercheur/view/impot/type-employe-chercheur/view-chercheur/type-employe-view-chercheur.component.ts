...
@Component({
  selector: 'app-type-employe-view-chercheur',
  templateUrl: './type-employe-view-chercheur.component.html',
  styleUrls: ['./type-employe-view-chercheur.component.css']
})
export class TypeEmployeViewChercheurComponent implements OnInit {
