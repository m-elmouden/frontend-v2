...
@Component({
  selector: 'app-type-employe-list-chercheur',
  templateUrl: './type-employe-list-chercheur.component.html',
  styleUrls: ['./type-employe-list-chercheur.component.css']
})
export class TypeEmployeListChercheurComponent implements OnInit {
   // declarations
