...
@Component({
  selector: 'app-type-employe-create-chercheur',
  templateUrl: './type-employe-create-chercheur.component.html',
  styleUrls: ['./type-employe-create-chercheur.component.css']
})
export class TypeEmployeCreateChercheurComponent implements OnInit {
