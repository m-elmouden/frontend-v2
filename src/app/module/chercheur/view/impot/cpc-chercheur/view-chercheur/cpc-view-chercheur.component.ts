...
@Component({
  selector: 'app-cpc-view-chercheur',
  templateUrl: './cpc-view-chercheur.component.html',
  styleUrls: ['./cpc-view-chercheur.component.css']
})
export class CpcViewChercheurComponent implements OnInit {
