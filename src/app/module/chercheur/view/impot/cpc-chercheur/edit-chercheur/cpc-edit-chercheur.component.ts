...
@Component({
  selector: 'app-cpc-edit-chercheur',
  templateUrl: './cpc-edit-chercheur.component.html',
  styleUrls: ['./cpc-edit-chercheur.component.css']
})
export class CpcEditChercheurComponent implements OnInit {
