...
@Component({
  selector: 'app-cpc-list-chercheur',
  templateUrl: './cpc-list-chercheur.component.html',
  styleUrls: ['./cpc-list-chercheur.component.css']
})
export class CpcListChercheurComponent implements OnInit {
   // declarations
