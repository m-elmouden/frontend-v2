...
@Component({
  selector: 'app-cpc-create-chercheur',
  templateUrl: './cpc-create-chercheur.component.html',
  styleUrls: ['./cpc-create-chercheur.component.css']
})
export class CpcCreateChercheurComponent implements OnInit {
