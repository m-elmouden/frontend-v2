...
@Component({
  selector: 'app-declaration-ir-create-chercheur',
  templateUrl: './declaration-ir-create-chercheur.component.html',
  styleUrls: ['./declaration-ir-create-chercheur.component.css']
})
export class DeclarationIrCreateChercheurComponent implements OnInit {
