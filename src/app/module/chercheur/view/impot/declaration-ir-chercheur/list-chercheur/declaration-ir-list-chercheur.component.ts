...
@Component({
  selector: 'app-declaration-ir-list-chercheur',
  templateUrl: './declaration-ir-list-chercheur.component.html',
  styleUrls: ['./declaration-ir-list-chercheur.component.css']
})
export class DeclarationIrListChercheurComponent implements OnInit {
   // declarations
...
public async duplicateDeclarationIr(declarationIr: DeclarationIrVo) {
	...
	initDuplicateDeclarationIr(res: DeclarationIrVo) {
        if (res.declarationIrEmployesVo != null) {
             res.declarationIrEmployesVo.forEach(d => { d.declarationIrVo = null; d.id = null; });
                }
        if (res.prelevementSocialEmployesVo != null) {
             res.prelevementSocialEmployesVo.forEach(d => { d.declarationIrVo = null; d.id = null; });
                }
