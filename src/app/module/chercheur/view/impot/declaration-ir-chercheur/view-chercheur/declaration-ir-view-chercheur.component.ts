...
@Component({
  selector: 'app-declaration-ir-view-chercheur',
  templateUrl: './declaration-ir-view-chercheur.component.html',
  styleUrls: ['./declaration-ir-view-chercheur.component.css']
})
export class DeclarationIrViewChercheurComponent implements OnInit {
