...
@Component({
  selector: 'app-declaration-ir-edit-chercheur',
  templateUrl: './declaration-ir-edit-chercheur.component.html',
  styleUrls: ['./declaration-ir-edit-chercheur.component.css']
})
export class DeclarationIrEditChercheurComponent implements OnInit {
