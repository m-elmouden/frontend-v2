...
@Component({
  selector: 'app-etat-paiement-edit-chercheur',
  templateUrl: './etat-paiement-edit-chercheur.component.html',
  styleUrls: ['./etat-paiement-edit-chercheur.component.css']
})
export class EtatPaiementEditChercheurComponent implements OnInit {
