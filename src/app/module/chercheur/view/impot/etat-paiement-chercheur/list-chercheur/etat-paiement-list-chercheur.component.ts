...
@Component({
  selector: 'app-etat-paiement-list-chercheur',
  templateUrl: './etat-paiement-list-chercheur.component.html',
  styleUrls: ['./etat-paiement-list-chercheur.component.css']
})
export class EtatPaiementListChercheurComponent implements OnInit {
   // declarations
