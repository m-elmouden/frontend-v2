...
@Component({
  selector: 'app-etat-paiement-create-chercheur',
  templateUrl: './etat-paiement-create-chercheur.component.html',
  styleUrls: ['./etat-paiement-create-chercheur.component.css']
})
export class EtatPaiementCreateChercheurComponent implements OnInit {
