...
@Component({
  selector: 'app-paiement-declaration-ir-list-chercheur',
  templateUrl: './paiement-declaration-ir-list-chercheur.component.html',
  styleUrls: ['./paiement-declaration-ir-list-chercheur.component.css']
})
export class PaiementDeclarationIrListChercheurComponent implements OnInit {
   // declarations
