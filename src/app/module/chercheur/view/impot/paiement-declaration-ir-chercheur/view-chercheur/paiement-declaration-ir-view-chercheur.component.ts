...
@Component({
  selector: 'app-paiement-declaration-ir-view-chercheur',
  templateUrl: './paiement-declaration-ir-view-chercheur.component.html',
  styleUrls: ['./paiement-declaration-ir-view-chercheur.component.css']
})
export class PaiementDeclarationIrViewChercheurComponent implements OnInit {
