...
@Component({
  selector: 'app-declaration-is-edit-chercheur',
  templateUrl: './declaration-is-edit-chercheur.component.html',
  styleUrls: ['./declaration-is-edit-chercheur.component.css']
})
export class DeclarationIsEditChercheurComponent implements OnInit {
