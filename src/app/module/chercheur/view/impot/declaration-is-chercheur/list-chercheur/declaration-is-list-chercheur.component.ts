...
@Component({
  selector: 'app-declaration-is-list-chercheur',
  templateUrl: './declaration-is-list-chercheur.component.html',
  styleUrls: ['./declaration-is-list-chercheur.component.css']
})
export class DeclarationIsListChercheurComponent implements OnInit {
   // declarations
