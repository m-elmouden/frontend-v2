...
@Component({
  selector: 'app-declaration-is-view-chercheur',
  templateUrl: './declaration-is-view-chercheur.component.html',
  styleUrls: ['./declaration-is-view-chercheur.component.css']
})
export class DeclarationIsViewChercheurComponent implements OnInit {
