...
@Component({
  selector: 'app-declaration-is-create-chercheur',
  templateUrl: './declaration-is-create-chercheur.component.html',
  styleUrls: ['./declaration-is-create-chercheur.component.css']
})
export class DeclarationIsCreateChercheurComponent implements OnInit {
