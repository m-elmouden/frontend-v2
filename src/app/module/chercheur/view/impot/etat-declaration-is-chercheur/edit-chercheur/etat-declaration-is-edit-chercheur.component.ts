...
@Component({
  selector: 'app-etat-declaration-is-edit-chercheur',
  templateUrl: './etat-declaration-is-edit-chercheur.component.html',
  styleUrls: ['./etat-declaration-is-edit-chercheur.component.css']
})
export class EtatDeclarationIsEditChercheurComponent implements OnInit {
