...
@Component({
  selector: 'app-etat-declaration-is-view-chercheur',
  templateUrl: './etat-declaration-is-view-chercheur.component.html',
  styleUrls: ['./etat-declaration-is-view-chercheur.component.css']
})
export class EtatDeclarationIsViewChercheurComponent implements OnInit {
