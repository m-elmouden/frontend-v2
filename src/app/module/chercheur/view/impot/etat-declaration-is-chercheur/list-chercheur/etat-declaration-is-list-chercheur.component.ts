...
@Component({
  selector: 'app-etat-declaration-is-list-chercheur',
  templateUrl: './etat-declaration-is-list-chercheur.component.html',
  styleUrls: ['./etat-declaration-is-list-chercheur.component.css']
})
export class EtatDeclarationIsListChercheurComponent implements OnInit {
   // declarations
