...
@Component({
  selector: 'app-etat-declaration-is-create-chercheur',
  templateUrl: './etat-declaration-is-create-chercheur.component.html',
  styleUrls: ['./etat-declaration-is-create-chercheur.component.css']
})
export class EtatDeclarationIsCreateChercheurComponent implements OnInit {
