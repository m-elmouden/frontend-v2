...
@Component({
  selector: 'app-declaration-tva-create-chercheur',
  templateUrl: './declaration-tva-create-chercheur.component.html',
  styleUrls: ['./declaration-tva-create-chercheur.component.css']
})
export class DeclarationTvaCreateChercheurComponent implements OnInit {
