...
@Component({
  selector: 'app-declaration-tva-view-chercheur',
  templateUrl: './declaration-tva-view-chercheur.component.html',
  styleUrls: ['./declaration-tva-view-chercheur.component.css']
})
export class DeclarationTvaViewChercheurComponent implements OnInit {
