...
@Component({
  selector: 'app-declaration-tva-edit-chercheur',
  templateUrl: './declaration-tva-edit-chercheur.component.html',
  styleUrls: ['./declaration-tva-edit-chercheur.component.css']
})
export class DeclarationTvaEditChercheurComponent implements OnInit {
