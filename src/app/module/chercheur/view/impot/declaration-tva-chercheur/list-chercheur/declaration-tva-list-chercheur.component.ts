...
@Component({
  selector: 'app-declaration-tva-list-chercheur',
  templateUrl: './declaration-tva-list-chercheur.component.html',
  styleUrls: ['./declaration-tva-list-chercheur.component.css']
})
export class DeclarationTvaListChercheurComponent implements OnInit {
   // declarations
