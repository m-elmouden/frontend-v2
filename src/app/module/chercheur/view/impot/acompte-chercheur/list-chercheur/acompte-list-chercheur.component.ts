...
@Component({
  selector: 'app-acompte-list-chercheur',
  templateUrl: './acompte-list-chercheur.component.html',
  styleUrls: ['./acompte-list-chercheur.component.css']
})
export class AcompteListChercheurComponent implements OnInit {
   // declarations
