...
@Component({
  selector: 'app-paiement-declaration-is-create-chercheur',
  templateUrl: './paiement-declaration-is-create-chercheur.component.html',
  styleUrls: ['./paiement-declaration-is-create-chercheur.component.css']
})
export class PaiementDeclarationIsCreateChercheurComponent implements OnInit {
