...
@Component({
  selector: 'app-paiement-declaration-is-view-chercheur',
  templateUrl: './paiement-declaration-is-view-chercheur.component.html',
  styleUrls: ['./paiement-declaration-is-view-chercheur.component.css']
})
export class PaiementDeclarationIsViewChercheurComponent implements OnInit {
