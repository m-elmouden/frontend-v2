...
@Component({
  selector: 'app-paiement-declaration-is-edit-chercheur',
  templateUrl: './paiement-declaration-is-edit-chercheur.component.html',
  styleUrls: ['./paiement-declaration-is-edit-chercheur.component.css']
})
export class PaiementDeclarationIsEditChercheurComponent implements OnInit {
