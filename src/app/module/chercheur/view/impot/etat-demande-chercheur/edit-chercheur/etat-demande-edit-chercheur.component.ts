...
@Component({
  selector: 'app-etat-demande-edit-chercheur',
  templateUrl: './etat-demande-edit-chercheur.component.html',
  styleUrls: ['./etat-demande-edit-chercheur.component.css']
})
export class EtatDemandeEditChercheurComponent implements OnInit {
