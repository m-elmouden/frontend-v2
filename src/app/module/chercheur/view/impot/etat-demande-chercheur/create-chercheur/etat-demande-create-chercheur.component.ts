...
@Component({
  selector: 'app-etat-demande-create-chercheur',
  templateUrl: './etat-demande-create-chercheur.component.html',
  styleUrls: ['./etat-demande-create-chercheur.component.css']
})
export class EtatDemandeCreateChercheurComponent implements OnInit {
