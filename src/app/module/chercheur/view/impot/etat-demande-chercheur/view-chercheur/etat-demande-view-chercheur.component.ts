...
@Component({
  selector: 'app-etat-demande-view-chercheur',
  templateUrl: './etat-demande-view-chercheur.component.html',
  styleUrls: ['./etat-demande-view-chercheur.component.css']
})
export class EtatDemandeViewChercheurComponent implements OnInit {
