...
@Component({
  selector: 'app-taux-cnss-create-chercheur',
  templateUrl: './taux-cnss-create-chercheur.component.html',
  styleUrls: ['./taux-cnss-create-chercheur.component.css']
})
export class TauxCnssCreateChercheurComponent implements OnInit {
