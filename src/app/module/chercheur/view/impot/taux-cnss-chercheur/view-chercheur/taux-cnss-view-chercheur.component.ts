...
@Component({
  selector: 'app-taux-cnss-view-chercheur',
  templateUrl: './taux-cnss-view-chercheur.component.html',
  styleUrls: ['./taux-cnss-view-chercheur.component.css']
})
export class TauxCnssViewChercheurComponent implements OnInit {
