...
@Component({
  selector: 'app-taux-cnss-list-chercheur',
  templateUrl: './taux-cnss-list-chercheur.component.html',
  styleUrls: ['./taux-cnss-list-chercheur.component.css']
})
export class TauxCnssListChercheurComponent implements OnInit {
   // declarations
