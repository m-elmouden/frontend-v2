...
@Component({
  selector: 'app-taux-cnss-edit-chercheur',
  templateUrl: './taux-cnss-edit-chercheur.component.html',
  styleUrls: ['./taux-cnss-edit-chercheur.component.css']
})
export class TauxCnssEditChercheurComponent implements OnInit {
