...
@Component({
  selector: 'app-type-societe-list-chercheur',
  templateUrl: './type-societe-list-chercheur.component.html',
  styleUrls: ['./type-societe-list-chercheur.component.css']
})
export class TypeSocieteListChercheurComponent implements OnInit {
   // declarations
