...
@Component({
  selector: 'app-type-societe-edit-chercheur',
  templateUrl: './type-societe-edit-chercheur.component.html',
  styleUrls: ['./type-societe-edit-chercheur.component.css']
})
export class TypeSocieteEditChercheurComponent implements OnInit {
