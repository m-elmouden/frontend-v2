...
@Component({
  selector: 'app-type-societe-view-chercheur',
  templateUrl: './type-societe-view-chercheur.component.html',
  styleUrls: ['./type-societe-view-chercheur.component.css']
})
export class TypeSocieteViewChercheurComponent implements OnInit {
