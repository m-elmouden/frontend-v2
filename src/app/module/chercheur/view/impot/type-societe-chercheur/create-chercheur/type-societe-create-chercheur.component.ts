...
@Component({
  selector: 'app-type-societe-create-chercheur',
  templateUrl: './type-societe-create-chercheur.component.html',
  styleUrls: ['./type-societe-create-chercheur.component.css']
})
export class TypeSocieteCreateChercheurComponent implements OnInit {
