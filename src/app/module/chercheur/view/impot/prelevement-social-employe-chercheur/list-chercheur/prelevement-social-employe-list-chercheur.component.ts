...
@Component({
  selector: 'app-prelevement-social-employe-list-chercheur',
  templateUrl: './prelevement-social-employe-list-chercheur.component.html',
  styleUrls: ['./prelevement-social-employe-list-chercheur.component.css']
})
export class PrelevementSocialEmployeListChercheurComponent implements OnInit {
   // declarations
