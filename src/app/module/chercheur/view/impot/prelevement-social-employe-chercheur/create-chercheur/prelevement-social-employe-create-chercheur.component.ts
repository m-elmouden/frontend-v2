...
@Component({
  selector: 'app-prelevement-social-employe-create-chercheur',
  templateUrl: './prelevement-social-employe-create-chercheur.component.html',
  styleUrls: ['./prelevement-social-employe-create-chercheur.component.css']
})
export class PrelevementSocialEmployeCreateChercheurComponent implements OnInit {
