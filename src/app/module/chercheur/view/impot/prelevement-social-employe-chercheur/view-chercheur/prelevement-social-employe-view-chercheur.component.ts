...
@Component({
  selector: 'app-prelevement-social-employe-view-chercheur',
  templateUrl: './prelevement-social-employe-view-chercheur.component.html',
  styleUrls: ['./prelevement-social-employe-view-chercheur.component.css']
})
export class PrelevementSocialEmployeViewChercheurComponent implements OnInit {
