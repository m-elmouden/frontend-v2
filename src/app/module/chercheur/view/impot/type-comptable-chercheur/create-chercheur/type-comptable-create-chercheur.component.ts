...
@Component({
  selector: 'app-type-comptable-create-chercheur',
  templateUrl: './type-comptable-create-chercheur.component.html',
  styleUrls: ['./type-comptable-create-chercheur.component.css']
})
export class TypeComptableCreateChercheurComponent implements OnInit {
