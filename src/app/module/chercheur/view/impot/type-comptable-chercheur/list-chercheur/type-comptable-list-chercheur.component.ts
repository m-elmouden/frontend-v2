...
@Component({
  selector: 'app-type-comptable-list-chercheur',
  templateUrl: './type-comptable-list-chercheur.component.html',
  styleUrls: ['./type-comptable-list-chercheur.component.css']
})
export class TypeComptableListChercheurComponent implements OnInit {
   // declarations
