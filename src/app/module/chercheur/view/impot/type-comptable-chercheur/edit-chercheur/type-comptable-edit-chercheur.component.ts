...
@Component({
  selector: 'app-type-comptable-edit-chercheur',
  templateUrl: './type-comptable-edit-chercheur.component.html',
  styleUrls: ['./type-comptable-edit-chercheur.component.css']
})
export class TypeComptableEditChercheurComponent implements OnInit {
