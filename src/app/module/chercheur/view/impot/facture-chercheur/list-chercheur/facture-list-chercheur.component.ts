...
@Component({
  selector: 'app-facture-list-chercheur',
  templateUrl: './facture-list-chercheur.component.html',
  styleUrls: ['./facture-list-chercheur.component.css']
})
export class FactureListChercheurComponent implements OnInit {
   // declarations
