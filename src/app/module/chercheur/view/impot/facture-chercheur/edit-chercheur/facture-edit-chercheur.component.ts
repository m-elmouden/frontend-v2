...
@Component({
  selector: 'app-facture-edit-chercheur',
  templateUrl: './facture-edit-chercheur.component.html',
  styleUrls: ['./facture-edit-chercheur.component.css']
})
export class FactureEditChercheurComponent implements OnInit {
