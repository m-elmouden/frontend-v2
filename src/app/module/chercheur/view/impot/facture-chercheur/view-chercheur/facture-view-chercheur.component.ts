...
@Component({
  selector: 'app-facture-view-chercheur',
  templateUrl: './facture-view-chercheur.component.html',
  styleUrls: ['./facture-view-chercheur.component.css']
})
export class FactureViewChercheurComponent implements OnInit {
