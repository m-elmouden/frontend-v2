...
@Component({
  selector: 'app-type-declaration-tva-create-chercheur',
  templateUrl: './type-declaration-tva-create-chercheur.component.html',
  styleUrls: ['./type-declaration-tva-create-chercheur.component.css']
})
export class TypeDeclarationTvaCreateChercheurComponent implements OnInit {
