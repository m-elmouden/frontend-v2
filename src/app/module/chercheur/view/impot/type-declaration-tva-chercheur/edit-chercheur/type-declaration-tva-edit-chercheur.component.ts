...
@Component({
  selector: 'app-type-declaration-tva-edit-chercheur',
  templateUrl: './type-declaration-tva-edit-chercheur.component.html',
  styleUrls: ['./type-declaration-tva-edit-chercheur.component.css']
})
export class TypeDeclarationTvaEditChercheurComponent implements OnInit {
