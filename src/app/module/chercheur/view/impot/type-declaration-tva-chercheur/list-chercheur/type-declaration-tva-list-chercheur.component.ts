...
@Component({
  selector: 'app-type-declaration-tva-list-chercheur',
  templateUrl: './type-declaration-tva-list-chercheur.component.html',
  styleUrls: ['./type-declaration-tva-list-chercheur.component.css']
})
export class TypeDeclarationTvaListChercheurComponent implements OnInit {
   // declarations
