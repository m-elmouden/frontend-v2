...
@Component({
  selector: 'app-etat-facture-edit-chercheur',
  templateUrl: './etat-facture-edit-chercheur.component.html',
  styleUrls: ['./etat-facture-edit-chercheur.component.css']
})
export class EtatFactureEditChercheurComponent implements OnInit {
