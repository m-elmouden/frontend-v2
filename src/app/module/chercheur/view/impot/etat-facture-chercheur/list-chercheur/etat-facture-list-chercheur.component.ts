...
@Component({
  selector: 'app-etat-facture-list-chercheur',
  templateUrl: './etat-facture-list-chercheur.component.html',
  styleUrls: ['./etat-facture-list-chercheur.component.css']
})
export class EtatFactureListChercheurComponent implements OnInit {
   // declarations
