...
@Component({
  selector: 'app-tva-view-chercheur',
  templateUrl: './tva-view-chercheur.component.html',
  styleUrls: ['./tva-view-chercheur.component.css']
})
export class TvaViewChercheurComponent implements OnInit {
