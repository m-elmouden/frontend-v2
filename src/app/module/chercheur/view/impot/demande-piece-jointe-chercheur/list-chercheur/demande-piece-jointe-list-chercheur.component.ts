...
@Component({
  selector: 'app-demande-piece-jointe-list-chercheur',
  templateUrl: './demande-piece-jointe-list-chercheur.component.html',
  styleUrls: ['./demande-piece-jointe-list-chercheur.component.css']
})
export class DemandePieceJointeListChercheurComponent implements OnInit {
   // declarations
