...
@Component({
  selector: 'app-demande-piece-jointe-edit-chercheur',
  templateUrl: './demande-piece-jointe-edit-chercheur.component.html',
  styleUrls: ['./demande-piece-jointe-edit-chercheur.component.css']
})
export class DemandePieceJointeEditChercheurComponent implements OnInit {
