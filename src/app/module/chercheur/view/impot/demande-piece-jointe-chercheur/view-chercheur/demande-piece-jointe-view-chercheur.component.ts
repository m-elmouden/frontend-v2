...
@Component({
  selector: 'app-demande-piece-jointe-view-chercheur',
  templateUrl: './demande-piece-jointe-view-chercheur.component.html',
  styleUrls: ['./demande-piece-jointe-view-chercheur.component.css']
})
export class DemandePieceJointeViewChercheurComponent implements OnInit {
