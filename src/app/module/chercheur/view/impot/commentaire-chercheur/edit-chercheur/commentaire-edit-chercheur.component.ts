...
@Component({
  selector: 'app-commentaire-edit-chercheur',
  templateUrl: './commentaire-edit-chercheur.component.html',
  styleUrls: ['./commentaire-edit-chercheur.component.css']
})
export class CommentaireEditChercheurComponent implements OnInit {
