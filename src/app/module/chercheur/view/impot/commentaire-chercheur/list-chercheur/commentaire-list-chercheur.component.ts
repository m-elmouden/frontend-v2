...
@Component({
  selector: 'app-commentaire-list-chercheur',
  templateUrl: './commentaire-list-chercheur.component.html',
  styleUrls: ['./commentaire-list-chercheur.component.css']
})
export class CommentaireListChercheurComponent implements OnInit {
   // declarations
