...
@Component({
  selector: 'app-commentaire-view-chercheur',
  templateUrl: './commentaire-view-chercheur.component.html',
  styleUrls: ['./commentaire-view-chercheur.component.css']
})
export class CommentaireViewChercheurComponent implements OnInit {
