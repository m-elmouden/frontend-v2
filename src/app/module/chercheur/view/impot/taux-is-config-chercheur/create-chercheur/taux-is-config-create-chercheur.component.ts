...
@Component({
  selector: 'app-taux-is-config-create-chercheur',
  templateUrl: './taux-is-config-create-chercheur.component.html',
  styleUrls: ['./taux-is-config-create-chercheur.component.css']
})
export class TauxIsConfigCreateChercheurComponent implements OnInit {
