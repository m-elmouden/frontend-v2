...
@Component({
  selector: 'app-taux-is-config-edit-chercheur',
  templateUrl: './taux-is-config-edit-chercheur.component.html',
  styleUrls: ['./taux-is-config-edit-chercheur.component.css']
})
export class TauxIsConfigEditChercheurComponent implements OnInit {
