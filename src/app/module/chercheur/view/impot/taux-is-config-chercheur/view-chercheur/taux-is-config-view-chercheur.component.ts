...
@Component({
  selector: 'app-taux-is-config-view-chercheur',
  templateUrl: './taux-is-config-view-chercheur.component.html',
  styleUrls: ['./taux-is-config-view-chercheur.component.css']
})
export class TauxIsConfigViewChercheurComponent implements OnInit {
