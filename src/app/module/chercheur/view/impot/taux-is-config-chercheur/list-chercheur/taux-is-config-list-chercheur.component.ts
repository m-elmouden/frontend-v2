...
@Component({
  selector: 'app-taux-is-config-list-chercheur',
  templateUrl: './taux-is-config-list-chercheur.component.html',
  styleUrls: ['./taux-is-config-list-chercheur.component.css']
})
export class TauxIsConfigListChercheurComponent implements OnInit {
   // declarations
