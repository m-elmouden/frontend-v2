...
@Component({
  selector: 'app-facture-piece-jointe-list-chercheur',
  templateUrl: './facture-piece-jointe-list-chercheur.component.html',
  styleUrls: ['./facture-piece-jointe-list-chercheur.component.css']
})
export class FacturePieceJointeListChercheurComponent implements OnInit {
   // declarations
