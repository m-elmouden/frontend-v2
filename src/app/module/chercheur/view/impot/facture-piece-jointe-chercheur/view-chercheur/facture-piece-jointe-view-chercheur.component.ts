...
@Component({
  selector: 'app-facture-piece-jointe-view-chercheur',
  templateUrl: './facture-piece-jointe-view-chercheur.component.html',
  styleUrls: ['./facture-piece-jointe-view-chercheur.component.css']
})
export class FacturePieceJointeViewChercheurComponent implements OnInit {
