...
@Component({
  selector: 'app-facture-piece-jointe-edit-chercheur',
  templateUrl: './facture-piece-jointe-edit-chercheur.component.html',
  styleUrls: ['./facture-piece-jointe-edit-chercheur.component.css']
})
export class FacturePieceJointeEditChercheurComponent implements OnInit {
