...
@Component({
  selector: 'app-type-taux-cnss-edit-chercheur',
  templateUrl: './type-taux-cnss-edit-chercheur.component.html',
  styleUrls: ['./type-taux-cnss-edit-chercheur.component.css']
})
export class TypeTauxCnssEditChercheurComponent implements OnInit {
