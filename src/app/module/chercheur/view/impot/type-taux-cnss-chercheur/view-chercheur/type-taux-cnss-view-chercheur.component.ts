...
@Component({
  selector: 'app-type-taux-cnss-view-chercheur',
  templateUrl: './type-taux-cnss-view-chercheur.component.html',
  styleUrls: ['./type-taux-cnss-view-chercheur.component.css']
})
export class TypeTauxCnssViewChercheurComponent implements OnInit {
