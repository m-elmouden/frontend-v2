...
@Component({
  selector: 'app-type-taux-cnss-create-chercheur',
  templateUrl: './type-taux-cnss-create-chercheur.component.html',
  styleUrls: ['./type-taux-cnss-create-chercheur.component.css']
})
export class TypeTauxCnssCreateChercheurComponent implements OnInit {
