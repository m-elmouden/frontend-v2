...
@Component({
  selector: 'app-declaration-cnss-edit-chercheur',
  templateUrl: './declaration-cnss-edit-chercheur.component.html',
  styleUrls: ['./declaration-cnss-edit-chercheur.component.css']
})
export class DeclarationCnssEditChercheurComponent implements OnInit {
