...
@Component({
  selector: 'app-declaration-cnss-view-chercheur',
  templateUrl: './declaration-cnss-view-chercheur.component.html',
  styleUrls: ['./declaration-cnss-view-chercheur.component.css']
})
export class DeclarationCnssViewChercheurComponent implements OnInit {
