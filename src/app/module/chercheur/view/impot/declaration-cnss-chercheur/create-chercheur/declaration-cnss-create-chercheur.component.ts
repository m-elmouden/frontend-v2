...
@Component({
  selector: 'app-declaration-cnss-create-chercheur',
  templateUrl: './declaration-cnss-create-chercheur.component.html',
  styleUrls: ['./declaration-cnss-create-chercheur.component.css']
})
export class DeclarationCnssCreateChercheurComponent implements OnInit {
