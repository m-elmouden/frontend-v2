...
@Component({
  selector: 'app-declaration-ir-employe-edit-chercheur',
  templateUrl: './declaration-ir-employe-edit-chercheur.component.html',
  styleUrls: ['./declaration-ir-employe-edit-chercheur.component.css']
})
export class DeclarationIrEmployeEditChercheurComponent implements OnInit {
