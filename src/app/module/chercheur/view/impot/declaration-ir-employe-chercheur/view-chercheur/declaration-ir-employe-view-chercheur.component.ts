...
@Component({
  selector: 'app-declaration-ir-employe-view-chercheur',
  templateUrl: './declaration-ir-employe-view-chercheur.component.html',
  styleUrls: ['./declaration-ir-employe-view-chercheur.component.css']
})
export class DeclarationIrEmployeViewChercheurComponent implements OnInit {
