...
@Component({
  selector: 'app-declaration-ir-employe-create-chercheur',
  templateUrl: './declaration-ir-employe-create-chercheur.component.html',
  styleUrls: ['./declaration-ir-employe-create-chercheur.component.css']
})
export class DeclarationIrEmployeCreateChercheurComponent implements OnInit {
