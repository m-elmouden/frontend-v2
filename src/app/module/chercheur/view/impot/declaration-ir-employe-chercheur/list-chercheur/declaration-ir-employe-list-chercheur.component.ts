...
@Component({
  selector: 'app-declaration-ir-employe-list-chercheur',
  templateUrl: './declaration-ir-employe-list-chercheur.component.html',
  styleUrls: ['./declaration-ir-employe-list-chercheur.component.css']
})
export class DeclarationIrEmployeListChercheurComponent implements OnInit {
   // declarations
