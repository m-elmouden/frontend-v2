...
@Component({
  selector: 'app-sous-classe-comptable-edit-chercheur',
  templateUrl: './sous-classe-comptable-edit-chercheur.component.html',
  styleUrls: ['./sous-classe-comptable-edit-chercheur.component.css']
})
export class SousClasseComptableEditChercheurComponent implements OnInit {
