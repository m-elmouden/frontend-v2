...
@Component({
  selector: 'app-sous-classe-comptable-create-chercheur',
  templateUrl: './sous-classe-comptable-create-chercheur.component.html',
  styleUrls: ['./sous-classe-comptable-create-chercheur.component.css']
})
export class SousClasseComptableCreateChercheurComponent implements OnInit {
