...
@Component({
  selector: 'app-sous-classe-comptable-list-chercheur',
  templateUrl: './sous-classe-comptable-list-chercheur.component.html',
  styleUrls: ['./sous-classe-comptable-list-chercheur.component.css']
})
export class SousClasseComptableListChercheurComponent implements OnInit {
   // declarations
