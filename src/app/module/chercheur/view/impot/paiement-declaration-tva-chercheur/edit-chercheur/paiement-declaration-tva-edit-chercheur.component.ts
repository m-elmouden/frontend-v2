...
@Component({
  selector: 'app-paiement-declaration-tva-edit-chercheur',
  templateUrl: './paiement-declaration-tva-edit-chercheur.component.html',
  styleUrls: ['./paiement-declaration-tva-edit-chercheur.component.css']
})
export class PaiementDeclarationTvaEditChercheurComponent implements OnInit {
