...
@Component({
  selector: 'app-paiement-declaration-tva-view-chercheur',
  templateUrl: './paiement-declaration-tva-view-chercheur.component.html',
  styleUrls: ['./paiement-declaration-tva-view-chercheur.component.css']
})
export class PaiementDeclarationTvaViewChercheurComponent implements OnInit {
