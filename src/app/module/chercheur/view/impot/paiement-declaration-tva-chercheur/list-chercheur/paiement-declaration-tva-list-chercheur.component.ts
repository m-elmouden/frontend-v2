...
@Component({
  selector: 'app-paiement-declaration-tva-list-chercheur',
  templateUrl: './paiement-declaration-tva-list-chercheur.component.html',
  styleUrls: ['./paiement-declaration-tva-list-chercheur.component.css']
})
export class PaiementDeclarationTvaListChercheurComponent implements OnInit {
   // declarations
