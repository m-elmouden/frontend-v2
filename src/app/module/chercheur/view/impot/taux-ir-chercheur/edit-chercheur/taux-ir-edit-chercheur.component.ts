...
@Component({
  selector: 'app-taux-ir-edit-chercheur',
  templateUrl: './taux-ir-edit-chercheur.component.html',
  styleUrls: ['./taux-ir-edit-chercheur.component.css']
})
export class TauxIrEditChercheurComponent implements OnInit {
