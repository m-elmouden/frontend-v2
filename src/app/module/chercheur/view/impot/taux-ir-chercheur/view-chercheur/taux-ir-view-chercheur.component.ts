...
@Component({
  selector: 'app-taux-ir-view-chercheur',
  templateUrl: './taux-ir-view-chercheur.component.html',
  styleUrls: ['./taux-ir-view-chercheur.component.css']
})
export class TauxIrViewChercheurComponent implements OnInit {
