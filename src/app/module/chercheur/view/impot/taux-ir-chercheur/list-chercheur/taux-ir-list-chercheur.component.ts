...
@Component({
  selector: 'app-taux-ir-list-chercheur',
  templateUrl: './taux-ir-list-chercheur.component.html',
  styleUrls: ['./taux-ir-list-chercheur.component.css']
})
export class TauxIrListChercheurComponent implements OnInit {
   // declarations
