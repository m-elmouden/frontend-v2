...
@Component({
  selector: 'app-prelevement-social-edit-chercheur',
  templateUrl: './prelevement-social-edit-chercheur.component.html',
  styleUrls: ['./prelevement-social-edit-chercheur.component.css']
})
export class PrelevementSocialEditChercheurComponent implements OnInit {
