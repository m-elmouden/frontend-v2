...
@Component({
  selector: 'app-prelevement-social-create-chercheur',
  templateUrl: './prelevement-social-create-chercheur.component.html',
  styleUrls: ['./prelevement-social-create-chercheur.component.css']
})
export class PrelevementSocialCreateChercheurComponent implements OnInit {
