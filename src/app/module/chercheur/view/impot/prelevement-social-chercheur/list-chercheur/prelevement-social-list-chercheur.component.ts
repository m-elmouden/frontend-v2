...
@Component({
  selector: 'app-prelevement-social-list-chercheur',
  templateUrl: './prelevement-social-list-chercheur.component.html',
  styleUrls: ['./prelevement-social-list-chercheur.component.css']
})
export class PrelevementSocialListChercheurComponent implements OnInit {
   // declarations
