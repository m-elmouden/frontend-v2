...
@Component({
  selector: 'app-type-operation-facture-view-chercheur',
  templateUrl: './type-operation-facture-view-chercheur.component.html',
  styleUrls: ['./type-operation-facture-view-chercheur.component.css']
})
export class TypeOperationFactureViewChercheurComponent implements OnInit {
