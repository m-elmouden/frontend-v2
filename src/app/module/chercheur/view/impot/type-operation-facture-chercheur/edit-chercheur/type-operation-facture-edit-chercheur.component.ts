...
@Component({
  selector: 'app-type-operation-facture-edit-chercheur',
  templateUrl: './type-operation-facture-edit-chercheur.component.html',
  styleUrls: ['./type-operation-facture-edit-chercheur.component.css']
})
export class TypeOperationFactureEditChercheurComponent implements OnInit {
