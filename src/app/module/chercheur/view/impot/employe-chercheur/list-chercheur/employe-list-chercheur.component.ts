...
@Component({
  selector: 'app-employe-list-chercheur',
  templateUrl: './employe-list-chercheur.component.html',
  styleUrls: ['./employe-list-chercheur.component.css']
})
export class EmployeListChercheurComponent implements OnInit {
   // declarations
