...
@Component({
  selector: 'app-employe-create-chercheur',
  templateUrl: './employe-create-chercheur.component.html',
  styleUrls: ['./employe-create-chercheur.component.css']
})
export class EmployeCreateChercheurComponent implements OnInit {
