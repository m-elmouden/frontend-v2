...
@Component({
  selector: 'app-comptable-create-chercheur',
  templateUrl: './comptable-create-chercheur.component.html',
  styleUrls: ['./comptable-create-chercheur.component.css']
})
export class ComptableCreateChercheurComponent implements OnInit {
