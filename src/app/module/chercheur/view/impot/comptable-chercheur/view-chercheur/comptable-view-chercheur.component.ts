...
@Component({
  selector: 'app-comptable-view-chercheur',
  templateUrl: './comptable-view-chercheur.component.html',
  styleUrls: ['./comptable-view-chercheur.component.css']
})
export class ComptableViewChercheurComponent implements OnInit {
