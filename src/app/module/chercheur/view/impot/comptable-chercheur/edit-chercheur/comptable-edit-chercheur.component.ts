...
@Component({
  selector: 'app-comptable-edit-chercheur',
  templateUrl: './comptable-edit-chercheur.component.html',
  styleUrls: ['./comptable-edit-chercheur.component.css']
})
export class ComptableEditChercheurComponent implements OnInit {
