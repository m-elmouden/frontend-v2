...
@Component({
  selector: 'app-comptable-list-chercheur',
  templateUrl: './comptable-list-chercheur.component.html',
  styleUrls: ['./comptable-list-chercheur.component.css']
})
export class ComptableListChercheurComponent implements OnInit {
   // declarations
