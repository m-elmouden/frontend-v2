...
@Component({
  selector: 'app-etat-declaration-tva-edit-chercheur',
  templateUrl: './etat-declaration-tva-edit-chercheur.component.html',
  styleUrls: ['./etat-declaration-tva-edit-chercheur.component.css']
})
export class EtatDeclarationTvaEditChercheurComponent implements OnInit {
