...
@Component({
  selector: 'app-etat-declaration-tva-create-chercheur',
  templateUrl: './etat-declaration-tva-create-chercheur.component.html',
  styleUrls: ['./etat-declaration-tva-create-chercheur.component.css']
})
export class EtatDeclarationTvaCreateChercheurComponent implements OnInit {
