...
@Component({
  selector: 'app-cpc-facture-list-chercheur',
  templateUrl: './cpc-facture-list-chercheur.component.html',
  styleUrls: ['./cpc-facture-list-chercheur.component.css']
})
export class CpcFactureListChercheurComponent implements OnInit {
   // declarations
