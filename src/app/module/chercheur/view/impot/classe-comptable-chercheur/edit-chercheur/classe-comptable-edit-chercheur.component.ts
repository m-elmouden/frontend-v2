...
@Component({
  selector: 'app-classe-comptable-edit-chercheur',
  templateUrl: './classe-comptable-edit-chercheur.component.html',
  styleUrls: ['./classe-comptable-edit-chercheur.component.css']
})
export class ClasseComptableEditChercheurComponent implements OnInit {
