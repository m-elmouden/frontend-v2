...
@Component({
  selector: 'app-classe-comptable-list-chercheur',
  templateUrl: './classe-comptable-list-chercheur.component.html',
  styleUrls: ['./classe-comptable-list-chercheur.component.css']
})
export class ClasseComptableListChercheurComponent implements OnInit {
   // declarations
