...
@Component({
  selector: 'app-classe-comptable-create-chercheur',
  templateUrl: './classe-comptable-create-chercheur.component.html',
  styleUrls: ['./classe-comptable-create-chercheur.component.css']
})
export class ClasseComptableCreateChercheurComponent implements OnInit {
