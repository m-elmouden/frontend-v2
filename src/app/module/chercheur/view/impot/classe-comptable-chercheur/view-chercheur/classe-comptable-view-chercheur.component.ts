...
@Component({
  selector: 'app-classe-comptable-view-chercheur',
  templateUrl: './classe-comptable-view-chercheur.component.html',
  styleUrls: ['./classe-comptable-view-chercheur.component.css']
})
export class ClasseComptableViewChercheurComponent implements OnInit {
