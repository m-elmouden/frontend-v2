...
@Component({
  selector: 'app-declaration-cnss-detail-list-chercheur',
  templateUrl: './declaration-cnss-detail-list-chercheur.component.html',
  styleUrls: ['./declaration-cnss-detail-list-chercheur.component.css']
})
export class DeclarationCnssDetailListChercheurComponent implements OnInit {
   // declarations
