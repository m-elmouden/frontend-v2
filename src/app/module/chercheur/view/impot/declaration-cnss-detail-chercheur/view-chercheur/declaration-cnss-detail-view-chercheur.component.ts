...
@Component({
  selector: 'app-declaration-cnss-detail-view-chercheur',
  templateUrl: './declaration-cnss-detail-view-chercheur.component.html',
  styleUrls: ['./declaration-cnss-detail-view-chercheur.component.css']
})
export class DeclarationCnssDetailViewChercheurComponent implements OnInit {
