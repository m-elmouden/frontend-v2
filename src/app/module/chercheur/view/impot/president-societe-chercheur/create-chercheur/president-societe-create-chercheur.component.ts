...
@Component({
  selector: 'app-president-societe-create-chercheur',
  templateUrl: './president-societe-create-chercheur.component.html',
  styleUrls: ['./president-societe-create-chercheur.component.css']
})
export class PresidentSocieteCreateChercheurComponent implements OnInit {
