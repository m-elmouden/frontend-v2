...
@Component({
  selector: 'app-president-societe-view-chercheur',
  templateUrl: './president-societe-view-chercheur.component.html',
  styleUrls: ['./president-societe-view-chercheur.component.css']
})
export class PresidentSocieteViewChercheurComponent implements OnInit {
