...
@Component({
  selector: 'app-president-societe-edit-chercheur',
  templateUrl: './president-societe-edit-chercheur.component.html',
  styleUrls: ['./president-societe-edit-chercheur.component.css']
})
export class PresidentSocieteEditChercheurComponent implements OnInit {
