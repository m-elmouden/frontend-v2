...
@Component({
  selector: 'app-etat-declaration-is-edit-comptable',
  templateUrl: './etat-declaration-is-edit-comptable.component.html',
  styleUrls: ['./etat-declaration-is-edit-comptable.component.css']
})
export class EtatDeclarationIsEditComptableComponent implements OnInit {
