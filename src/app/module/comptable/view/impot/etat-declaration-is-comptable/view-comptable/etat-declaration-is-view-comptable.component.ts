...
@Component({
  selector: 'app-etat-declaration-is-view-comptable',
  templateUrl: './etat-declaration-is-view-comptable.component.html',
  styleUrls: ['./etat-declaration-is-view-comptable.component.css']
})
export class EtatDeclarationIsViewComptableComponent implements OnInit {
