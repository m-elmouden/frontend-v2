...
@Component({
  selector: 'app-societe-create-comptable',
  templateUrl: './societe-create-comptable.component.html',
  styleUrls: ['./societe-create-comptable.component.css']
})
export class SocieteCreateComptableComponent implements OnInit {
