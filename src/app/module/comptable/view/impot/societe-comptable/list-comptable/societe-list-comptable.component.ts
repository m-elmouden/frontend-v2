...
@Component({
  selector: 'app-societe-list-comptable',
  templateUrl: './societe-list-comptable.component.html',
  styleUrls: ['./societe-list-comptable.component.css']
})
export class SocieteListComptableComponent implements OnInit {
   // declarations
