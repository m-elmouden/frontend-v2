...
@Component({
  selector: 'app-societe-view-comptable',
  templateUrl: './societe-view-comptable.component.html',
  styleUrls: ['./societe-view-comptable.component.css']
})
export class SocieteViewComptableComponent implements OnInit {
