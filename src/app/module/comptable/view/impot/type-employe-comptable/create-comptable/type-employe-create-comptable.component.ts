...
@Component({
  selector: 'app-type-employe-create-comptable',
  templateUrl: './type-employe-create-comptable.component.html',
  styleUrls: ['./type-employe-create-comptable.component.css']
})
export class TypeEmployeCreateComptableComponent implements OnInit {
