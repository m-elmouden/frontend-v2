...
@Component({
  selector: 'app-type-employe-list-comptable',
  templateUrl: './type-employe-list-comptable.component.html',
  styleUrls: ['./type-employe-list-comptable.component.css']
})
export class TypeEmployeListComptableComponent implements OnInit {
   // declarations
