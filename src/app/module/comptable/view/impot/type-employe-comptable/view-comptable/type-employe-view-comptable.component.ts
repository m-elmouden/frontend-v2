...
@Component({
  selector: 'app-type-employe-view-comptable',
  templateUrl: './type-employe-view-comptable.component.html',
  styleUrls: ['./type-employe-view-comptable.component.css']
})
export class TypeEmployeViewComptableComponent implements OnInit {
