...
@Component({
  selector: 'app-type-employe-edit-comptable',
  templateUrl: './type-employe-edit-comptable.component.html',
  styleUrls: ['./type-employe-edit-comptable.component.css']
})
export class TypeEmployeEditComptableComponent implements OnInit {
