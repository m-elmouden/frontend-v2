...
@Component({
  selector: 'app-chercheur-list-comptable',
  templateUrl: './chercheur-list-comptable.component.html',
  styleUrls: ['./chercheur-list-comptable.component.css']
})
export class ChercheurListComptableComponent implements OnInit {
   // declarations
