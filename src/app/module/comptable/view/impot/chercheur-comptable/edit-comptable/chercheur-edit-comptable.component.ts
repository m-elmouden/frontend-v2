...
@Component({
  selector: 'app-chercheur-edit-comptable',
  templateUrl: './chercheur-edit-comptable.component.html',
  styleUrls: ['./chercheur-edit-comptable.component.css']
})
export class ChercheurEditComptableComponent implements OnInit {
