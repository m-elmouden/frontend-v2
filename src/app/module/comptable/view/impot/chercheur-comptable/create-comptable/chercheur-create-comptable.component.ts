...
@Component({
  selector: 'app-chercheur-create-comptable',
  templateUrl: './chercheur-create-comptable.component.html',
  styleUrls: ['./chercheur-create-comptable.component.css']
})
export class ChercheurCreateComptableComponent implements OnInit {
