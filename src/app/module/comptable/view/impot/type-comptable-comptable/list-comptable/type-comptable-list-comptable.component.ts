...
@Component({
  selector: 'app-type-comptable-list-comptable',
  templateUrl: './type-comptable-list-comptable.component.html',
  styleUrls: ['./type-comptable-list-comptable.component.css']
})
export class TypeComptableListComptableComponent implements OnInit {
   // declarations
