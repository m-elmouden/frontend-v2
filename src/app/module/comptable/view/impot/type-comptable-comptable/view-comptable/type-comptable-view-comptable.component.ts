...
@Component({
  selector: 'app-type-comptable-view-comptable',
  templateUrl: './type-comptable-view-comptable.component.html',
  styleUrls: ['./type-comptable-view-comptable.component.css']
})
export class TypeComptableViewComptableComponent implements OnInit {
