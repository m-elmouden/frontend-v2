...
@Component({
  selector: 'app-type-comptable-create-comptable',
  templateUrl: './type-comptable-create-comptable.component.html',
  styleUrls: ['./type-comptable-create-comptable.component.css']
})
export class TypeComptableCreateComptableComponent implements OnInit {
