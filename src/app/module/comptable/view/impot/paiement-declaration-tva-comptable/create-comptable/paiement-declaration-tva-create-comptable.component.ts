...
@Component({
  selector: 'app-paiement-declaration-tva-create-comptable',
  templateUrl: './paiement-declaration-tva-create-comptable.component.html',
  styleUrls: ['./paiement-declaration-tva-create-comptable.component.css']
})
export class PaiementDeclarationTvaCreateComptableComponent implements OnInit {
