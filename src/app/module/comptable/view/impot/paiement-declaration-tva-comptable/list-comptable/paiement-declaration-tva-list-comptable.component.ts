...
@Component({
  selector: 'app-paiement-declaration-tva-list-comptable',
  templateUrl: './paiement-declaration-tva-list-comptable.component.html',
  styleUrls: ['./paiement-declaration-tva-list-comptable.component.css']
})
export class PaiementDeclarationTvaListComptableComponent implements OnInit {
   // declarations
