...
@Component({
  selector: 'app-compte-comptable-view-comptable',
  templateUrl: './compte-comptable-view-comptable.component.html',
  styleUrls: ['./compte-comptable-view-comptable.component.css']
})
export class CompteComptableViewComptableComponent implements OnInit {
