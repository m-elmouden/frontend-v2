...
@Component({
  selector: 'app-compte-comptable-list-comptable',
  templateUrl: './compte-comptable-list-comptable.component.html',
  styleUrls: ['./compte-comptable-list-comptable.component.css']
})
export class CompteComptableListComptableComponent implements OnInit {
   // declarations
