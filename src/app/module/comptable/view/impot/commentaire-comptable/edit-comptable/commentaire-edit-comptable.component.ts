...
@Component({
  selector: 'app-commentaire-edit-comptable',
  templateUrl: './commentaire-edit-comptable.component.html',
  styleUrls: ['./commentaire-edit-comptable.component.css']
})
export class CommentaireEditComptableComponent implements OnInit {
