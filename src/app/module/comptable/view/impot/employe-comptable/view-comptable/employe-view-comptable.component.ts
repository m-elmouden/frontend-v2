...
@Component({
  selector: 'app-employe-view-comptable',
  templateUrl: './employe-view-comptable.component.html',
  styleUrls: ['./employe-view-comptable.component.css']
})
export class EmployeViewComptableComponent implements OnInit {
