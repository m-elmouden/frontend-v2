...
@Component({
  selector: 'app-employe-list-comptable',
  templateUrl: './employe-list-comptable.component.html',
  styleUrls: ['./employe-list-comptable.component.css']
})
export class EmployeListComptableComponent implements OnInit {
   // declarations
