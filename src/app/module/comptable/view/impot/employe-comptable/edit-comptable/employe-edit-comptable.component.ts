...
@Component({
  selector: 'app-employe-edit-comptable',
  templateUrl: './employe-edit-comptable.component.html',
  styleUrls: ['./employe-edit-comptable.component.css']
})
export class EmployeEditComptableComponent implements OnInit {
