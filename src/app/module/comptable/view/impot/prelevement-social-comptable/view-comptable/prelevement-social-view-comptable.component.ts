...
@Component({
  selector: 'app-prelevement-social-view-comptable',
  templateUrl: './prelevement-social-view-comptable.component.html',
  styleUrls: ['./prelevement-social-view-comptable.component.css']
})
export class PrelevementSocialViewComptableComponent implements OnInit {
