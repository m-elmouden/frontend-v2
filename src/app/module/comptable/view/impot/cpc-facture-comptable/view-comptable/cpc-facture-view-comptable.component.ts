...
@Component({
  selector: 'app-cpc-facture-view-comptable',
  templateUrl: './cpc-facture-view-comptable.component.html',
  styleUrls: ['./cpc-facture-view-comptable.component.css']
})
export class CpcFactureViewComptableComponent implements OnInit {
