...
@Component({
  selector: 'app-cpc-facture-edit-comptable',
  templateUrl: './cpc-facture-edit-comptable.component.html',
  styleUrls: ['./cpc-facture-edit-comptable.component.css']
})
export class CpcFactureEditComptableComponent implements OnInit {
