...
@Component({
  selector: 'app-cpc-facture-create-comptable',
  templateUrl: './cpc-facture-create-comptable.component.html',
  styleUrls: ['./cpc-facture-create-comptable.component.css']
})
export class CpcFactureCreateComptableComponent implements OnInit {
