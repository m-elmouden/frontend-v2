...
@Component({
  selector: 'app-classe-comptable-create-comptable',
  templateUrl: './classe-comptable-create-comptable.component.html',
  styleUrls: ['./classe-comptable-create-comptable.component.css']
})
export class ClasseComptableCreateComptableComponent implements OnInit {
