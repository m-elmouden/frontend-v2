...
@Component({
  selector: 'app-classe-comptable-list-comptable',
  templateUrl: './classe-comptable-list-comptable.component.html',
  styleUrls: ['./classe-comptable-list-comptable.component.css']
})
export class ClasseComptableListComptableComponent implements OnInit {
   // declarations
