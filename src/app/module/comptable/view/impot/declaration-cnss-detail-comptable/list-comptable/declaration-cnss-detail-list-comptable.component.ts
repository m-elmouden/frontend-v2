...
@Component({
  selector: 'app-declaration-cnss-detail-list-comptable',
  templateUrl: './declaration-cnss-detail-list-comptable.component.html',
  styleUrls: ['./declaration-cnss-detail-list-comptable.component.css']
})
export class DeclarationCnssDetailListComptableComponent implements OnInit {
   // declarations
