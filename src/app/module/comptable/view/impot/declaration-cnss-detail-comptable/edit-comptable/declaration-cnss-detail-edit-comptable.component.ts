...
@Component({
  selector: 'app-declaration-cnss-detail-edit-comptable',
  templateUrl: './declaration-cnss-detail-edit-comptable.component.html',
  styleUrls: ['./declaration-cnss-detail-edit-comptable.component.css']
})
export class DeclarationCnssDetailEditComptableComponent implements OnInit {
