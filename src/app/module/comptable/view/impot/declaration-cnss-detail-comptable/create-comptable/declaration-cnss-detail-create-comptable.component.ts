...
@Component({
  selector: 'app-declaration-cnss-detail-create-comptable',
  templateUrl: './declaration-cnss-detail-create-comptable.component.html',
  styleUrls: ['./declaration-cnss-detail-create-comptable.component.css']
})
export class DeclarationCnssDetailCreateComptableComponent implements OnInit {
