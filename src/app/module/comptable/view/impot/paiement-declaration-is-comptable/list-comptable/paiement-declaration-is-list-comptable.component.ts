...
@Component({
  selector: 'app-paiement-declaration-is-list-comptable',
  templateUrl: './paiement-declaration-is-list-comptable.component.html',
  styleUrls: ['./paiement-declaration-is-list-comptable.component.css']
})
export class PaiementDeclarationIsListComptableComponent implements OnInit {
   // declarations
