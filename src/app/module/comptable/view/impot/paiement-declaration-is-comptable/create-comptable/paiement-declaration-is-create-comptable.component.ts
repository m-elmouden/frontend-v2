...
@Component({
  selector: 'app-paiement-declaration-is-create-comptable',
  templateUrl: './paiement-declaration-is-create-comptable.component.html',
  styleUrls: ['./paiement-declaration-is-create-comptable.component.css']
})
export class PaiementDeclarationIsCreateComptableComponent implements OnInit {
