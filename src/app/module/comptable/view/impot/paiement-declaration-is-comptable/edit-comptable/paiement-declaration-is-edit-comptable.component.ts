...
@Component({
  selector: 'app-paiement-declaration-is-edit-comptable',
  templateUrl: './paiement-declaration-is-edit-comptable.component.html',
  styleUrls: ['./paiement-declaration-is-edit-comptable.component.css']
})
export class PaiementDeclarationIsEditComptableComponent implements OnInit {
