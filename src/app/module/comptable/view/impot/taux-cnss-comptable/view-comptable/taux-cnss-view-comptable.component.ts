...
@Component({
  selector: 'app-taux-cnss-view-comptable',
  templateUrl: './taux-cnss-view-comptable.component.html',
  styleUrls: ['./taux-cnss-view-comptable.component.css']
})
export class TauxCnssViewComptableComponent implements OnInit {
