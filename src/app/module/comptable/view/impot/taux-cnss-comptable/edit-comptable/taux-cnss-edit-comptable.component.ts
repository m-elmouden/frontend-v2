...
@Component({
  selector: 'app-taux-cnss-edit-comptable',
  templateUrl: './taux-cnss-edit-comptable.component.html',
  styleUrls: ['./taux-cnss-edit-comptable.component.css']
})
export class TauxCnssEditComptableComponent implements OnInit {
