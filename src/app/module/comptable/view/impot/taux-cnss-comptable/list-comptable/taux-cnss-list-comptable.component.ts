...
@Component({
  selector: 'app-taux-cnss-list-comptable',
  templateUrl: './taux-cnss-list-comptable.component.html',
  styleUrls: ['./taux-cnss-list-comptable.component.css']
})
export class TauxCnssListComptableComponent implements OnInit {
   // declarations
