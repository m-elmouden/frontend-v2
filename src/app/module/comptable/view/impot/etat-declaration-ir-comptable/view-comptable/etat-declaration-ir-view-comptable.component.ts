...
@Component({
  selector: 'app-etat-declaration-ir-view-comptable',
  templateUrl: './etat-declaration-ir-view-comptable.component.html',
  styleUrls: ['./etat-declaration-ir-view-comptable.component.css']
})
export class EtatDeclarationIrViewComptableComponent implements OnInit {
