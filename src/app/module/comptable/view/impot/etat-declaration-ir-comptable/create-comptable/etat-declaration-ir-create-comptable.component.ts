...
@Component({
  selector: 'app-etat-declaration-ir-create-comptable',
  templateUrl: './etat-declaration-ir-create-comptable.component.html',
  styleUrls: ['./etat-declaration-ir-create-comptable.component.css']
})
export class EtatDeclarationIrCreateComptableComponent implements OnInit {
