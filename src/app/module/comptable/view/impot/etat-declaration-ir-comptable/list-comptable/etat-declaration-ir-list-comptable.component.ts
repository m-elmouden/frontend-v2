...
@Component({
  selector: 'app-etat-declaration-ir-list-comptable',
  templateUrl: './etat-declaration-ir-list-comptable.component.html',
  styleUrls: ['./etat-declaration-ir-list-comptable.component.css']
})
export class EtatDeclarationIrListComptableComponent implements OnInit {
   // declarations
