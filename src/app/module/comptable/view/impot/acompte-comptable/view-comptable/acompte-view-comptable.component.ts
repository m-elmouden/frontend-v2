...
@Component({
  selector: 'app-acompte-view-comptable',
  templateUrl: './acompte-view-comptable.component.html',
  styleUrls: ['./acompte-view-comptable.component.css']
})
export class AcompteViewComptableComponent implements OnInit {
