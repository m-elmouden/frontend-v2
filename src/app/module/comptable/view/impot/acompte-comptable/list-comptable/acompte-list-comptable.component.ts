...
@Component({
  selector: 'app-acompte-list-comptable',
  templateUrl: './acompte-list-comptable.component.html',
  styleUrls: ['./acompte-list-comptable.component.css']
})
export class AcompteListComptableComponent implements OnInit {
   // declarations
