...
@Component({
  selector: 'app-declaration-cnss-edit-comptable',
  templateUrl: './declaration-cnss-edit-comptable.component.html',
  styleUrls: ['./declaration-cnss-edit-comptable.component.css']
})
export class DeclarationCnssEditComptableComponent implements OnInit {
