...
@Component({
  selector: 'app-declaration-cnss-view-comptable',
  templateUrl: './declaration-cnss-view-comptable.component.html',
  styleUrls: ['./declaration-cnss-view-comptable.component.css']
})
export class DeclarationCnssViewComptableComponent implements OnInit {
