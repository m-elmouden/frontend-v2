...
@Component({
  selector: 'app-declaration-cnss-list-comptable',
  templateUrl: './declaration-cnss-list-comptable.component.html',
  styleUrls: ['./declaration-cnss-list-comptable.component.css']
})
export class DeclarationCnssListComptableComponent implements OnInit {
   // declarations
...
public async archiverDeclarationCnss(declarationCnss:DeclarationCnssVo){
const isPermistted = await this.roleService.isPermitted('DeclarationCnss', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Declaration cnss) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.declarationCnssService.archiver(declarationCnss).subscribe(status=>{
const myIndex = this.declarationCnsss.indexOf(declarationCnss);
this.declarationCnsss[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Declaration cnss archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverDeclarationCnss(declarationCnss:DeclarationCnssVo){
const isPermistted = await this.roleService.isPermitted('DeclarationCnss', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Declaration cnss) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.declarationCnssService.desarchiver(declarationCnss).subscribe(status=>{
const myIndex = this.declarationCnsss.indexOf(declarationCnss);
this.declarationCnsss[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Declaration cnss désarchivé',
life: 3000
});
},error=>console.log(error))
 }
