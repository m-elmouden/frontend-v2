...
@Component({
  selector: 'app-type-operation-facture-create-comptable',
  templateUrl: './type-operation-facture-create-comptable.component.html',
  styleUrls: ['./type-operation-facture-create-comptable.component.css']
})
export class TypeOperationFactureCreateComptableComponent implements OnInit {
