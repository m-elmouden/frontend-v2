...
@Component({
  selector: 'app-type-operation-facture-view-comptable',
  templateUrl: './type-operation-facture-view-comptable.component.html',
  styleUrls: ['./type-operation-facture-view-comptable.component.css']
})
export class TypeOperationFactureViewComptableComponent implements OnInit {
