...
@Component({
  selector: 'app-type-operation-facture-list-comptable',
  templateUrl: './type-operation-facture-list-comptable.component.html',
  styleUrls: ['./type-operation-facture-list-comptable.component.css']
})
export class TypeOperationFactureListComptableComponent implements OnInit {
   // declarations
