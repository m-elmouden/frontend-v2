...
@Component({
  selector: 'app-etat-demande-view-comptable',
  templateUrl: './etat-demande-view-comptable.component.html',
  styleUrls: ['./etat-demande-view-comptable.component.css']
})
export class EtatDemandeViewComptableComponent implements OnInit {
