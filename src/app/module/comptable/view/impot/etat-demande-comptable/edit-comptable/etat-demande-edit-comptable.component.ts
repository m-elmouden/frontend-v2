...
@Component({
  selector: 'app-etat-demande-edit-comptable',
  templateUrl: './etat-demande-edit-comptable.component.html',
  styleUrls: ['./etat-demande-edit-comptable.component.css']
})
export class EtatDemandeEditComptableComponent implements OnInit {
