...
@Component({
  selector: 'app-etat-demande-list-comptable',
  templateUrl: './etat-demande-list-comptable.component.html',
  styleUrls: ['./etat-demande-list-comptable.component.css']
})
export class EtatDemandeListComptableComponent implements OnInit {
   // declarations
