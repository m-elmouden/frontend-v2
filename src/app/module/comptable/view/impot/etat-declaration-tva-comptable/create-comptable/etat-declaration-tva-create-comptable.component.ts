...
@Component({
  selector: 'app-etat-declaration-tva-create-comptable',
  templateUrl: './etat-declaration-tva-create-comptable.component.html',
  styleUrls: ['./etat-declaration-tva-create-comptable.component.css']
})
export class EtatDeclarationTvaCreateComptableComponent implements OnInit {
