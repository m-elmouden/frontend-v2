...
@Component({
  selector: 'app-etat-declaration-tva-view-comptable',
  templateUrl: './etat-declaration-tva-view-comptable.component.html',
  styleUrls: ['./etat-declaration-tva-view-comptable.component.css']
})
export class EtatDeclarationTvaViewComptableComponent implements OnInit {
