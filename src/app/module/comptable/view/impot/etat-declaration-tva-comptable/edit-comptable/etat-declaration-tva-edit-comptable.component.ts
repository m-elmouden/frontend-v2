...
@Component({
  selector: 'app-etat-declaration-tva-edit-comptable',
  templateUrl: './etat-declaration-tva-edit-comptable.component.html',
  styleUrls: ['./etat-declaration-tva-edit-comptable.component.css']
})
export class EtatDeclarationTvaEditComptableComponent implements OnInit {
