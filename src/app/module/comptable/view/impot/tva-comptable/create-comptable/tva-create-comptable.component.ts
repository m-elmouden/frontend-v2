...
@Component({
  selector: 'app-tva-create-comptable',
  templateUrl: './tva-create-comptable.component.html',
  styleUrls: ['./tva-create-comptable.component.css']
})
export class TvaCreateComptableComponent implements OnInit {
