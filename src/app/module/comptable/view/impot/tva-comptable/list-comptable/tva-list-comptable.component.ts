...
@Component({
  selector: 'app-tva-list-comptable',
  templateUrl: './tva-list-comptable.component.html',
  styleUrls: ['./tva-list-comptable.component.css']
})
export class TvaListComptableComponent implements OnInit {
   // declarations
