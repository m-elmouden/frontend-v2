...
@Component({
  selector: 'app-tva-edit-comptable',
  templateUrl: './tva-edit-comptable.component.html',
  styleUrls: ['./tva-edit-comptable.component.css']
})
export class TvaEditComptableComponent implements OnInit {
