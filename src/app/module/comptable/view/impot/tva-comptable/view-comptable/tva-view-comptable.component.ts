...
@Component({
  selector: 'app-tva-view-comptable',
  templateUrl: './tva-view-comptable.component.html',
  styleUrls: ['./tva-view-comptable.component.css']
})
export class TvaViewComptableComponent implements OnInit {
