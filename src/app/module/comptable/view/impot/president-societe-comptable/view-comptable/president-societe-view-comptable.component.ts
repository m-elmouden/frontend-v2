...
@Component({
  selector: 'app-president-societe-view-comptable',
  templateUrl: './president-societe-view-comptable.component.html',
  styleUrls: ['./president-societe-view-comptable.component.css']
})
export class PresidentSocieteViewComptableComponent implements OnInit {
