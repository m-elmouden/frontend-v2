...
@Component({
  selector: 'app-president-societe-create-comptable',
  templateUrl: './president-societe-create-comptable.component.html',
  styleUrls: ['./president-societe-create-comptable.component.css']
})
export class PresidentSocieteCreateComptableComponent implements OnInit {
