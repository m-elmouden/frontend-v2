...
@Component({
  selector: 'app-president-societe-list-comptable',
  templateUrl: './president-societe-list-comptable.component.html',
  styleUrls: ['./president-societe-list-comptable.component.css']
})
export class PresidentSocieteListComptableComponent implements OnInit {
   // declarations
