...
@Component({
  selector: 'app-taux-is-create-comptable',
  templateUrl: './taux-is-create-comptable.component.html',
  styleUrls: ['./taux-is-create-comptable.component.css']
})
export class TauxIsCreateComptableComponent implements OnInit {
