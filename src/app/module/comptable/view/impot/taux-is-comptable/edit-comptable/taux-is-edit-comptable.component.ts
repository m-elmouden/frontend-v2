...
@Component({
  selector: 'app-taux-is-edit-comptable',
  templateUrl: './taux-is-edit-comptable.component.html',
  styleUrls: ['./taux-is-edit-comptable.component.css']
})
export class TauxIsEditComptableComponent implements OnInit {
