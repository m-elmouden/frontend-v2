...
@Component({
  selector: 'app-taux-is-list-comptable',
  templateUrl: './taux-is-list-comptable.component.html',
  styleUrls: ['./taux-is-list-comptable.component.css']
})
export class TauxIsListComptableComponent implements OnInit {
   // declarations
