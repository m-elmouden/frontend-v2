...
@Component({
  selector: 'app-taux-is-view-comptable',
  templateUrl: './taux-is-view-comptable.component.html',
  styleUrls: ['./taux-is-view-comptable.component.css']
})
export class TauxIsViewComptableComponent implements OnInit {
