...
@Component({
  selector: 'app-declaration-tva-list-comptable',
  templateUrl: './declaration-tva-list-comptable.component.html',
  styleUrls: ['./declaration-tva-list-comptable.component.css']
})
export class DeclarationTvaListComptableComponent implements OnInit {
   // declarations
