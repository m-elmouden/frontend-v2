...
@Component({
  selector: 'app-declaration-tva-create-comptable',
  templateUrl: './declaration-tva-create-comptable.component.html',
  styleUrls: ['./declaration-tva-create-comptable.component.css']
})
export class DeclarationTvaCreateComptableComponent implements OnInit {
