...
@Component({
  selector: 'app-declaration-tva-edit-comptable',
  templateUrl: './declaration-tva-edit-comptable.component.html',
  styleUrls: ['./declaration-tva-edit-comptable.component.css']
})
export class DeclarationTvaEditComptableComponent implements OnInit {
