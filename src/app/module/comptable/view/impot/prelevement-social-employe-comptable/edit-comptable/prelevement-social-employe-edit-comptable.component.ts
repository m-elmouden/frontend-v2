...
@Component({
  selector: 'app-prelevement-social-employe-edit-comptable',
  templateUrl: './prelevement-social-employe-edit-comptable.component.html',
  styleUrls: ['./prelevement-social-employe-edit-comptable.component.css']
})
export class PrelevementSocialEmployeEditComptableComponent implements OnInit {
