...
@Component({
  selector: 'app-prelevement-social-employe-create-comptable',
  templateUrl: './prelevement-social-employe-create-comptable.component.html',
  styleUrls: ['./prelevement-social-employe-create-comptable.component.css']
})
export class PrelevementSocialEmployeCreateComptableComponent implements OnInit {
