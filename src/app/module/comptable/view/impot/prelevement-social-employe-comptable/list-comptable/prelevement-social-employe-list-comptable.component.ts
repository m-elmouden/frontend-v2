...
@Component({
  selector: 'app-prelevement-social-employe-list-comptable',
  templateUrl: './prelevement-social-employe-list-comptable.component.html',
  styleUrls: ['./prelevement-social-employe-list-comptable.component.css']
})
export class PrelevementSocialEmployeListComptableComponent implements OnInit {
   // declarations
