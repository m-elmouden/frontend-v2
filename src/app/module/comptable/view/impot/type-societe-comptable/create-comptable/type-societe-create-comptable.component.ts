...
@Component({
  selector: 'app-type-societe-create-comptable',
  templateUrl: './type-societe-create-comptable.component.html',
  styleUrls: ['./type-societe-create-comptable.component.css']
})
export class TypeSocieteCreateComptableComponent implements OnInit {
