...
@Component({
  selector: 'app-type-societe-list-comptable',
  templateUrl: './type-societe-list-comptable.component.html',
  styleUrls: ['./type-societe-list-comptable.component.css']
})
export class TypeSocieteListComptableComponent implements OnInit {
   // declarations
