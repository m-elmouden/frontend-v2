...
@Component({
  selector: 'app-type-societe-edit-comptable',
  templateUrl: './type-societe-edit-comptable.component.html',
  styleUrls: ['./type-societe-edit-comptable.component.css']
})
export class TypeSocieteEditComptableComponent implements OnInit {
