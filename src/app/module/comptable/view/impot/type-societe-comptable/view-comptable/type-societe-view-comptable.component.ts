...
@Component({
  selector: 'app-type-societe-view-comptable',
  templateUrl: './type-societe-view-comptable.component.html',
  styleUrls: ['./type-societe-view-comptable.component.css']
})
export class TypeSocieteViewComptableComponent implements OnInit {
