...
@Component({
  selector: 'app-facture-piece-jointe-edit-comptable',
  templateUrl: './facture-piece-jointe-edit-comptable.component.html',
  styleUrls: ['./facture-piece-jointe-edit-comptable.component.css']
})
export class FacturePieceJointeEditComptableComponent implements OnInit {
