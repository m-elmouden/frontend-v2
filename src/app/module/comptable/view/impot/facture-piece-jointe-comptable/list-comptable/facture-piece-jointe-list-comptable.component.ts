...
@Component({
  selector: 'app-facture-piece-jointe-list-comptable',
  templateUrl: './facture-piece-jointe-list-comptable.component.html',
  styleUrls: ['./facture-piece-jointe-list-comptable.component.css']
})
export class FacturePieceJointeListComptableComponent implements OnInit {
   // declarations
