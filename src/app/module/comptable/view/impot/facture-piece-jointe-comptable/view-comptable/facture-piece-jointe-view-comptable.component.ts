...
@Component({
  selector: 'app-facture-piece-jointe-view-comptable',
  templateUrl: './facture-piece-jointe-view-comptable.component.html',
  styleUrls: ['./facture-piece-jointe-view-comptable.component.css']
})
export class FacturePieceJointeViewComptableComponent implements OnInit {
