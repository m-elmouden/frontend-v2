...
@Component({
  selector: 'app-type-taux-cnss-edit-comptable',
  templateUrl: './type-taux-cnss-edit-comptable.component.html',
  styleUrls: ['./type-taux-cnss-edit-comptable.component.css']
})
export class TypeTauxCnssEditComptableComponent implements OnInit {
