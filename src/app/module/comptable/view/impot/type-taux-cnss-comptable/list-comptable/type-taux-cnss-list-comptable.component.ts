...
@Component({
  selector: 'app-type-taux-cnss-list-comptable',
  templateUrl: './type-taux-cnss-list-comptable.component.html',
  styleUrls: ['./type-taux-cnss-list-comptable.component.css']
})
export class TypeTauxCnssListComptableComponent implements OnInit {
   // declarations
...
public async archiverTypeTauxCnss(typeTauxCnss:TypeTauxCnssVo){
const isPermistted = await this.roleService.isPermitted('TypeTauxCnss', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous archiver cet élément (Type taux cnss) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeTauxCnssService.archiver(typeTauxCnss).subscribe(status=>{
const myIndex = this.typeTauxCnsss.indexOf(typeTauxCnss);
this.typeTauxCnsss[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type taux cnss archivé',
life: 3000
});
},error=>console.log(error))
 }
...
public async desarchiverTypeTauxCnss(typeTauxCnss:TypeTauxCnssVo){
const isPermistted = await this.roleService.isPermitted('TypeTauxCnss', 'delete');
if(isPermistted){
this.confirmationService.confirm({
message: 'Voulez-vous désarchiver cet élément (Type taux cnss) ?',
header: 'Confirmation',
icon: 'pi pi-exclamation-triangle',
accept: () => {
this.typeTauxCnssService.desarchiver(typeTauxCnss).subscribe(status=>{
const myIndex = this.typeTauxCnsss.indexOf(typeTauxCnss);
this.typeTauxCnsss[myIndex] = status;
this.messageService.add({
severity: 'success',
summary: 'Succès',
detail: 'Type taux cnss désarchivé',
life: 3000
});
},error=>console.log(error))
 }
