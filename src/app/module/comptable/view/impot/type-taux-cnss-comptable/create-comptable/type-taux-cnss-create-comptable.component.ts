...
@Component({
  selector: 'app-type-taux-cnss-create-comptable',
  templateUrl: './type-taux-cnss-create-comptable.component.html',
  styleUrls: ['./type-taux-cnss-create-comptable.component.css']
})
export class TypeTauxCnssCreateComptableComponent implements OnInit {
