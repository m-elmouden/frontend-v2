...
@Component({
  selector: 'app-type-taux-cnss-view-comptable',
  templateUrl: './type-taux-cnss-view-comptable.component.html',
  styleUrls: ['./type-taux-cnss-view-comptable.component.css']
})
export class TypeTauxCnssViewComptableComponent implements OnInit {
