...
@Component({
  selector: 'app-type-declaration-tva-view-comptable',
  templateUrl: './type-declaration-tva-view-comptable.component.html',
  styleUrls: ['./type-declaration-tva-view-comptable.component.css']
})
export class TypeDeclarationTvaViewComptableComponent implements OnInit {
