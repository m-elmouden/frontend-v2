...
@Component({
  selector: 'app-type-declaration-tva-list-comptable',
  templateUrl: './type-declaration-tva-list-comptable.component.html',
  styleUrls: ['./type-declaration-tva-list-comptable.component.css']
})
export class TypeDeclarationTvaListComptableComponent implements OnInit {
   // declarations
