...
@Component({
  selector: 'app-type-declaration-tva-create-comptable',
  templateUrl: './type-declaration-tva-create-comptable.component.html',
  styleUrls: ['./type-declaration-tva-create-comptable.component.css']
})
export class TypeDeclarationTvaCreateComptableComponent implements OnInit {
