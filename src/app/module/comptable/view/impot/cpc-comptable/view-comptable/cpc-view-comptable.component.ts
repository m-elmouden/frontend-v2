...
@Component({
  selector: 'app-cpc-view-comptable',
  templateUrl: './cpc-view-comptable.component.html',
  styleUrls: ['./cpc-view-comptable.component.css']
})
export class CpcViewComptableComponent implements OnInit {
