...
@Component({
  selector: 'app-cpc-list-comptable',
  templateUrl: './cpc-list-comptable.component.html',
  styleUrls: ['./cpc-list-comptable.component.css']
})
export class CpcListComptableComponent implements OnInit {
   // declarations
