...
@Component({
  selector: 'app-cpc-edit-comptable',
  templateUrl: './cpc-edit-comptable.component.html',
  styleUrls: ['./cpc-edit-comptable.component.css']
})
export class CpcEditComptableComponent implements OnInit {
