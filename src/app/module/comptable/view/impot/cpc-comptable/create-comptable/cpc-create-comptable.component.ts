...
@Component({
  selector: 'app-cpc-create-comptable',
  templateUrl: './cpc-create-comptable.component.html',
  styleUrls: ['./cpc-create-comptable.component.css']
})
export class CpcCreateComptableComponent implements OnInit {
