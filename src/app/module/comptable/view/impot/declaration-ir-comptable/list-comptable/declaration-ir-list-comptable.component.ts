...
@Component({
  selector: 'app-declaration-ir-list-comptable',
  templateUrl: './declaration-ir-list-comptable.component.html',
  styleUrls: ['./declaration-ir-list-comptable.component.css']
})
export class DeclarationIrListComptableComponent implements OnInit {
   // declarations
