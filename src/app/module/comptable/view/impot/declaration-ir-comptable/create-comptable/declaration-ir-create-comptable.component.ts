...
@Component({
  selector: 'app-declaration-ir-create-comptable',
  templateUrl: './declaration-ir-create-comptable.component.html',
  styleUrls: ['./declaration-ir-create-comptable.component.css']
})
export class DeclarationIrCreateComptableComponent implements OnInit {
