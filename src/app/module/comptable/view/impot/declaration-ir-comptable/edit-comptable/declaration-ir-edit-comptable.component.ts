...
@Component({
  selector: 'app-declaration-ir-edit-comptable',
  templateUrl: './declaration-ir-edit-comptable.component.html',
  styleUrls: ['./declaration-ir-edit-comptable.component.css']
})
export class DeclarationIrEditComptableComponent implements OnInit {
