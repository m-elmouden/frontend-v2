...
@Component({
  selector: 'app-facture-create-comptable',
  templateUrl: './facture-create-comptable.component.html',
  styleUrls: ['./facture-create-comptable.component.css']
})
export class FactureCreateComptableComponent implements OnInit {
