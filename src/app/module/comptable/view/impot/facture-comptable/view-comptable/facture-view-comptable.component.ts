...
@Component({
  selector: 'app-facture-view-comptable',
  templateUrl: './facture-view-comptable.component.html',
  styleUrls: ['./facture-view-comptable.component.css']
})
export class FactureViewComptableComponent implements OnInit {
