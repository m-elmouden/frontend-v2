...
@Component({
  selector: 'app-sous-classe-comptable-create-comptable',
  templateUrl: './sous-classe-comptable-create-comptable.component.html',
  styleUrls: ['./sous-classe-comptable-create-comptable.component.css']
})
export class SousClasseComptableCreateComptableComponent implements OnInit {
