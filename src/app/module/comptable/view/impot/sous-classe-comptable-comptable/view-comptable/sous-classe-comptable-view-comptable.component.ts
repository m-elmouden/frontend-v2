...
@Component({
  selector: 'app-sous-classe-comptable-view-comptable',
  templateUrl: './sous-classe-comptable-view-comptable.component.html',
  styleUrls: ['./sous-classe-comptable-view-comptable.component.css']
})
export class SousClasseComptableViewComptableComponent implements OnInit {
