...
@Component({
  selector: 'app-sous-classe-comptable-list-comptable',
  templateUrl: './sous-classe-comptable-list-comptable.component.html',
  styleUrls: ['./sous-classe-comptable-list-comptable.component.css']
})
export class SousClasseComptableListComptableComponent implements OnInit {
   // declarations
