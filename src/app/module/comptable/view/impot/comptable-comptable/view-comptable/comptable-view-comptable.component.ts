...
@Component({
  selector: 'app-comptable-view-comptable',
  templateUrl: './comptable-view-comptable.component.html',
  styleUrls: ['./comptable-view-comptable.component.css']
})
export class ComptableViewComptableComponent implements OnInit {
