...
@Component({
  selector: 'app-demande-list-comptable',
  templateUrl: './demande-list-comptable.component.html',
  styleUrls: ['./demande-list-comptable.component.css']
})
export class DemandeListComptableComponent implements OnInit {
   // declarations
