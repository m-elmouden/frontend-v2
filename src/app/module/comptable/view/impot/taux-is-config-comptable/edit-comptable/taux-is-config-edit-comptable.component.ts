...
@Component({
  selector: 'app-taux-is-config-edit-comptable',
  templateUrl: './taux-is-config-edit-comptable.component.html',
  styleUrls: ['./taux-is-config-edit-comptable.component.css']
})
export class TauxIsConfigEditComptableComponent implements OnInit {
