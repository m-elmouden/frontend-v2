...
@Component({
  selector: 'app-taux-is-config-list-comptable',
  templateUrl: './taux-is-config-list-comptable.component.html',
  styleUrls: ['./taux-is-config-list-comptable.component.css']
})
export class TauxIsConfigListComptableComponent implements OnInit {
   // declarations
