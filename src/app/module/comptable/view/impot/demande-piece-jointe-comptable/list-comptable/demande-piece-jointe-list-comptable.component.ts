...
@Component({
  selector: 'app-demande-piece-jointe-list-comptable',
  templateUrl: './demande-piece-jointe-list-comptable.component.html',
  styleUrls: ['./demande-piece-jointe-list-comptable.component.css']
})
export class DemandePieceJointeListComptableComponent implements OnInit {
   // declarations
