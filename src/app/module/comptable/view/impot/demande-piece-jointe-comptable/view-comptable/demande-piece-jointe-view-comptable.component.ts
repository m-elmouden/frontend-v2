...
@Component({
  selector: 'app-demande-piece-jointe-view-comptable',
  templateUrl: './demande-piece-jointe-view-comptable.component.html',
  styleUrls: ['./demande-piece-jointe-view-comptable.component.css']
})
export class DemandePieceJointeViewComptableComponent implements OnInit {
