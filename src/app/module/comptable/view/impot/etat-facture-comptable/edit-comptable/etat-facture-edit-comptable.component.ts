...
@Component({
  selector: 'app-etat-facture-edit-comptable',
  templateUrl: './etat-facture-edit-comptable.component.html',
  styleUrls: ['./etat-facture-edit-comptable.component.css']
})
export class EtatFactureEditComptableComponent implements OnInit {
