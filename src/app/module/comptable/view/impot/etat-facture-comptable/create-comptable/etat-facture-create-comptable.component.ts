...
@Component({
  selector: 'app-etat-facture-create-comptable',
  templateUrl: './etat-facture-create-comptable.component.html',
  styleUrls: ['./etat-facture-create-comptable.component.css']
})
export class EtatFactureCreateComptableComponent implements OnInit {
