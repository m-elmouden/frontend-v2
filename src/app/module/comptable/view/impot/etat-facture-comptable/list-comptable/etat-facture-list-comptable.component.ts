...
@Component({
  selector: 'app-etat-facture-list-comptable',
  templateUrl: './etat-facture-list-comptable.component.html',
  styleUrls: ['./etat-facture-list-comptable.component.css']
})
export class EtatFactureListComptableComponent implements OnInit {
   // declarations
