...
@Component({
  selector: 'app-paiement-declaration-ir-edit-comptable',
  templateUrl: './paiement-declaration-ir-edit-comptable.component.html',
  styleUrls: ['./paiement-declaration-ir-edit-comptable.component.css']
})
export class PaiementDeclarationIrEditComptableComponent implements OnInit {
