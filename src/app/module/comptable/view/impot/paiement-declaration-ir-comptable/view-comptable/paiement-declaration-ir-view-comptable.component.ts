...
@Component({
  selector: 'app-paiement-declaration-ir-view-comptable',
  templateUrl: './paiement-declaration-ir-view-comptable.component.html',
  styleUrls: ['./paiement-declaration-ir-view-comptable.component.css']
})
export class PaiementDeclarationIrViewComptableComponent implements OnInit {
