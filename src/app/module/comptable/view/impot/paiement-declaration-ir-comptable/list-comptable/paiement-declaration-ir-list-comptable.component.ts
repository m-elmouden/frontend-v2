...
@Component({
  selector: 'app-paiement-declaration-ir-list-comptable',
  templateUrl: './paiement-declaration-ir-list-comptable.component.html',
  styleUrls: ['./paiement-declaration-ir-list-comptable.component.css']
})
export class PaiementDeclarationIrListComptableComponent implements OnInit {
   // declarations
