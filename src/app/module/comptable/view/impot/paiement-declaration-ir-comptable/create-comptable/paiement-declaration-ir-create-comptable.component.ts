...
@Component({
  selector: 'app-paiement-declaration-ir-create-comptable',
  templateUrl: './paiement-declaration-ir-create-comptable.component.html',
  styleUrls: ['./paiement-declaration-ir-create-comptable.component.css']
})
export class PaiementDeclarationIrCreateComptableComponent implements OnInit {
