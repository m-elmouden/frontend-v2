...
@Component({
  selector: 'app-declaration-ir-employe-list-comptable',
  templateUrl: './declaration-ir-employe-list-comptable.component.html',
  styleUrls: ['./declaration-ir-employe-list-comptable.component.css']
})
export class DeclarationIrEmployeListComptableComponent implements OnInit {
   // declarations
