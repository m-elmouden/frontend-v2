...
@Component({
  selector: 'app-declaration-ir-employe-view-comptable',
  templateUrl: './declaration-ir-employe-view-comptable.component.html',
  styleUrls: ['./declaration-ir-employe-view-comptable.component.css']
})
export class DeclarationIrEmployeViewComptableComponent implements OnInit {
