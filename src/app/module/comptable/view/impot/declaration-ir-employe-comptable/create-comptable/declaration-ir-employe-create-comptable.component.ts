...
@Component({
  selector: 'app-declaration-ir-employe-create-comptable',
  templateUrl: './declaration-ir-employe-create-comptable.component.html',
  styleUrls: ['./declaration-ir-employe-create-comptable.component.css']
})
export class DeclarationIrEmployeCreateComptableComponent implements OnInit {
