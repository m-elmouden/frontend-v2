...
@Component({
  selector: 'app-declaration-ir-employe-edit-comptable',
  templateUrl: './declaration-ir-employe-edit-comptable.component.html',
  styleUrls: ['./declaration-ir-employe-edit-comptable.component.css']
})
export class DeclarationIrEmployeEditComptableComponent implements OnInit {
