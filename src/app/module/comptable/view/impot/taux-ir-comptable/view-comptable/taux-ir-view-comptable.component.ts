...
@Component({
  selector: 'app-taux-ir-view-comptable',
  templateUrl: './taux-ir-view-comptable.component.html',
  styleUrls: ['./taux-ir-view-comptable.component.css']
})
export class TauxIrViewComptableComponent implements OnInit {
