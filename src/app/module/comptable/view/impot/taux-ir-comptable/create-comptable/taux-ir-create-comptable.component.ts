...
@Component({
  selector: 'app-taux-ir-create-comptable',
  templateUrl: './taux-ir-create-comptable.component.html',
  styleUrls: ['./taux-ir-create-comptable.component.css']
})
export class TauxIrCreateComptableComponent implements OnInit {
