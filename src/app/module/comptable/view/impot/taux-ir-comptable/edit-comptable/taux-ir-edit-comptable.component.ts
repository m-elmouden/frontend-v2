...
@Component({
  selector: 'app-taux-ir-edit-comptable',
  templateUrl: './taux-ir-edit-comptable.component.html',
  styleUrls: ['./taux-ir-edit-comptable.component.css']
})
export class TauxIrEditComptableComponent implements OnInit {
