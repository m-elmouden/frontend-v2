...
@Component({
  selector: 'app-taux-ir-list-comptable',
  templateUrl: './taux-ir-list-comptable.component.html',
  styleUrls: ['./taux-ir-list-comptable.component.css']
})
export class TauxIrListComptableComponent implements OnInit {
   // declarations
