...
@Component({
  selector: 'app-etat-paiement-view-comptable',
  templateUrl: './etat-paiement-view-comptable.component.html',
  styleUrls: ['./etat-paiement-view-comptable.component.css']
})
export class EtatPaiementViewComptableComponent implements OnInit {
