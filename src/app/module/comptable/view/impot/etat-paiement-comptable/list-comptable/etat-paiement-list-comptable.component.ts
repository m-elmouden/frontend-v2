...
@Component({
  selector: 'app-etat-paiement-list-comptable',
  templateUrl: './etat-paiement-list-comptable.component.html',
  styleUrls: ['./etat-paiement-list-comptable.component.css']
})
export class EtatPaiementListComptableComponent implements OnInit {
   // declarations
