...
@Component({
  selector: 'app-declaration-is-edit-comptable',
  templateUrl: './declaration-is-edit-comptable.component.html',
  styleUrls: ['./declaration-is-edit-comptable.component.css']
})
export class DeclarationIsEditComptableComponent implements OnInit {
