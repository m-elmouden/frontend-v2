...
@Component({
  selector: 'app-declaration-is-list-comptable',
  templateUrl: './declaration-is-list-comptable.component.html',
  styleUrls: ['./declaration-is-list-comptable.component.css']
})
export class DeclarationIsListComptableComponent implements OnInit {
   // declarations
