...
import { ImpotComptableModule } from './view/impot/impot-comptable.module';
import { ImpotComptableRoutingModule } from './view/impot/impot-comptable-routing.module';
...
@NgModule({
    ...
    imports: [
        ...
        BadgeModule,
        MultiSelectModule,
        ImpotComptableModule,
        ImpotComptableRoutingModule,
    ],
    exports: [
        LoginComptableComponent,
        RegisterComptableComponent,
