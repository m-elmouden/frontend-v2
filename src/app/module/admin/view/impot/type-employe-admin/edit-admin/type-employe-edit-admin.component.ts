...
@Component({
  selector: 'app-type-employe-edit-admin',
  templateUrl: './type-employe-edit-admin.component.html',
  styleUrls: ['./type-employe-edit-admin.component.css']
})
export class TypeEmployeEditAdminComponent implements OnInit {
