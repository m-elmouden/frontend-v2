...
@Component({
  selector: 'app-type-operation-facture-create-admin',
  templateUrl: './type-operation-facture-create-admin.component.html',
  styleUrls: ['./type-operation-facture-create-admin.component.css']
})
export class TypeOperationFactureCreateAdminComponent implements OnInit {
