...
@Component({
  selector: 'app-type-operation-facture-list-admin',
  templateUrl: './type-operation-facture-list-admin.component.html',
  styleUrls: ['./type-operation-facture-list-admin.component.css']
})
export class TypeOperationFactureListAdminComponent implements OnInit {
   // declarations
