...
@Component({
  selector: 'app-type-operation-facture-edit-admin',
  templateUrl: './type-operation-facture-edit-admin.component.html',
  styleUrls: ['./type-operation-facture-edit-admin.component.css']
})
export class TypeOperationFactureEditAdminComponent implements OnInit {
