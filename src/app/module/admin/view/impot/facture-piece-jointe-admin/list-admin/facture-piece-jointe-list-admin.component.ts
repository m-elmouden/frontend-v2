...
@Component({
  selector: 'app-facture-piece-jointe-list-admin',
  templateUrl: './facture-piece-jointe-list-admin.component.html',
  styleUrls: ['./facture-piece-jointe-list-admin.component.css']
})
export class FacturePieceJointeListAdminComponent implements OnInit {
   // declarations
