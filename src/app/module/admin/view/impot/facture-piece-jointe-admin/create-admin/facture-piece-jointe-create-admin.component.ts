...
@Component({
  selector: 'app-facture-piece-jointe-create-admin',
  templateUrl: './facture-piece-jointe-create-admin.component.html',
  styleUrls: ['./facture-piece-jointe-create-admin.component.css']
})
export class FacturePieceJointeCreateAdminComponent implements OnInit {
