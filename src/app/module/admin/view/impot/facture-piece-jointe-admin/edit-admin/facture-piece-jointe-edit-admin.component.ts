...
@Component({
  selector: 'app-facture-piece-jointe-edit-admin',
  templateUrl: './facture-piece-jointe-edit-admin.component.html',
  styleUrls: ['./facture-piece-jointe-edit-admin.component.css']
})
export class FacturePieceJointeEditAdminComponent implements OnInit {
