...
@Component({
  selector: 'app-declaration-cnss-detail-create-admin',
  templateUrl: './declaration-cnss-detail-create-admin.component.html',
  styleUrls: ['./declaration-cnss-detail-create-admin.component.css']
})
export class DeclarationCnssDetailCreateAdminComponent implements OnInit {
