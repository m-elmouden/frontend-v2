...
@Component({
  selector: 'app-declaration-cnss-detail-edit-admin',
  templateUrl: './declaration-cnss-detail-edit-admin.component.html',
  styleUrls: ['./declaration-cnss-detail-edit-admin.component.css']
})
export class DeclarationCnssDetailEditAdminComponent implements OnInit {
