...
@Component({
  selector: 'app-declaration-cnss-detail-view-admin',
  templateUrl: './declaration-cnss-detail-view-admin.component.html',
  styleUrls: ['./declaration-cnss-detail-view-admin.component.css']
})
export class DeclarationCnssDetailViewAdminComponent implements OnInit {
