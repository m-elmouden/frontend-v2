...
@Component({
  selector: 'app-etat-declaration-tva-list-admin',
  templateUrl: './etat-declaration-tva-list-admin.component.html',
  styleUrls: ['./etat-declaration-tva-list-admin.component.css']
})
export class EtatDeclarationTvaListAdminComponent implements OnInit {
   // declarations
