...
@Component({
  selector: 'app-etat-declaration-tva-create-admin',
  templateUrl: './etat-declaration-tva-create-admin.component.html',
  styleUrls: ['./etat-declaration-tva-create-admin.component.css']
})
export class EtatDeclarationTvaCreateAdminComponent implements OnInit {
