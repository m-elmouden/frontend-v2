...
@Component({
  selector: 'app-etat-declaration-tva-view-admin',
  templateUrl: './etat-declaration-tva-view-admin.component.html',
  styleUrls: ['./etat-declaration-tva-view-admin.component.css']
})
export class EtatDeclarationTvaViewAdminComponent implements OnInit {
