...
@Component({
  selector: 'app-prelevement-social-employe-list-admin',
  templateUrl: './prelevement-social-employe-list-admin.component.html',
  styleUrls: ['./prelevement-social-employe-list-admin.component.css']
})
export class PrelevementSocialEmployeListAdminComponent implements OnInit {
   // declarations
