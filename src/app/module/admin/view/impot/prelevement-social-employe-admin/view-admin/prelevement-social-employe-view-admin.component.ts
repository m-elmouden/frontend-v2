...
@Component({
  selector: 'app-prelevement-social-employe-view-admin',
  templateUrl: './prelevement-social-employe-view-admin.component.html',
  styleUrls: ['./prelevement-social-employe-view-admin.component.css']
})
export class PrelevementSocialEmployeViewAdminComponent implements OnInit {
