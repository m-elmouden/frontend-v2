...
@Component({
  selector: 'app-prelevement-social-employe-edit-admin',
  templateUrl: './prelevement-social-employe-edit-admin.component.html',
  styleUrls: ['./prelevement-social-employe-edit-admin.component.css']
})
export class PrelevementSocialEmployeEditAdminComponent implements OnInit {
