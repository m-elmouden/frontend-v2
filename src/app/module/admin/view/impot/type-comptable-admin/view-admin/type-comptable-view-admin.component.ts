...
@Component({
  selector: 'app-type-comptable-view-admin',
  templateUrl: './type-comptable-view-admin.component.html',
  styleUrls: ['./type-comptable-view-admin.component.css']
})
export class TypeComptableViewAdminComponent implements OnInit {
