...
@Component({
  selector: 'app-type-comptable-edit-admin',
  templateUrl: './type-comptable-edit-admin.component.html',
  styleUrls: ['./type-comptable-edit-admin.component.css']
})
export class TypeComptableEditAdminComponent implements OnInit {
