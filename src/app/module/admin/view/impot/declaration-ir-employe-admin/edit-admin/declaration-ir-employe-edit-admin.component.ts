...
@Component({
  selector: 'app-declaration-ir-employe-edit-admin',
  templateUrl: './declaration-ir-employe-edit-admin.component.html',
  styleUrls: ['./declaration-ir-employe-edit-admin.component.css']
})
export class DeclarationIrEmployeEditAdminComponent implements OnInit {
