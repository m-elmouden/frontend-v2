...
@Component({
  selector: 'app-declaration-ir-employe-list-admin',
  templateUrl: './declaration-ir-employe-list-admin.component.html',
  styleUrls: ['./declaration-ir-employe-list-admin.component.css']
})
export class DeclarationIrEmployeListAdminComponent implements OnInit {
   // declarations
