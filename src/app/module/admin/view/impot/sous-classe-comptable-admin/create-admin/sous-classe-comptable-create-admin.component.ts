...
@Component({
  selector: 'app-sous-classe-comptable-create-admin',
  templateUrl: './sous-classe-comptable-create-admin.component.html',
  styleUrls: ['./sous-classe-comptable-create-admin.component.css']
})
export class SousClasseComptableCreateAdminComponent implements OnInit {
