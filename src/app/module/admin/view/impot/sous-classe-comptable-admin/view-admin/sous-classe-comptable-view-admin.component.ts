...
@Component({
  selector: 'app-sous-classe-comptable-view-admin',
  templateUrl: './sous-classe-comptable-view-admin.component.html',
  styleUrls: ['./sous-classe-comptable-view-admin.component.css']
})
export class SousClasseComptableViewAdminComponent implements OnInit {
