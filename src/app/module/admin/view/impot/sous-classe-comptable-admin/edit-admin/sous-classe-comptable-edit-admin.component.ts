...
@Component({
  selector: 'app-sous-classe-comptable-edit-admin',
  templateUrl: './sous-classe-comptable-edit-admin.component.html',
  styleUrls: ['./sous-classe-comptable-edit-admin.component.css']
})
export class SousClasseComptableEditAdminComponent implements OnInit {
