...
@Component({
  selector: 'app-demande-piece-jointe-edit-admin',
  templateUrl: './demande-piece-jointe-edit-admin.component.html',
  styleUrls: ['./demande-piece-jointe-edit-admin.component.css']
})
export class DemandePieceJointeEditAdminComponent implements OnInit {
