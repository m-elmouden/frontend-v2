...
@Component({
  selector: 'app-demande-piece-jointe-create-admin',
  templateUrl: './demande-piece-jointe-create-admin.component.html',
  styleUrls: ['./demande-piece-jointe-create-admin.component.css']
})
export class DemandePieceJointeCreateAdminComponent implements OnInit {
