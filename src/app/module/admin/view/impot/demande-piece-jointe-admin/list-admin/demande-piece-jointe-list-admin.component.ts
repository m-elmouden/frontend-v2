...
@Component({
  selector: 'app-demande-piece-jointe-list-admin',
  templateUrl: './demande-piece-jointe-list-admin.component.html',
  styleUrls: ['./demande-piece-jointe-list-admin.component.css']
})
export class DemandePieceJointeListAdminComponent implements OnInit {
   // declarations
