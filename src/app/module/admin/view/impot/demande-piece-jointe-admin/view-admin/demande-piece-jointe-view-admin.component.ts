...
@Component({
  selector: 'app-demande-piece-jointe-view-admin',
  templateUrl: './demande-piece-jointe-view-admin.component.html',
  styleUrls: ['./demande-piece-jointe-view-admin.component.css']
})
export class DemandePieceJointeViewAdminComponent implements OnInit {
