...
@Component({
  selector: 'app-paiement-declaration-ir-create-admin',
  templateUrl: './paiement-declaration-ir-create-admin.component.html',
  styleUrls: ['./paiement-declaration-ir-create-admin.component.css']
})
export class PaiementDeclarationIrCreateAdminComponent implements OnInit {
