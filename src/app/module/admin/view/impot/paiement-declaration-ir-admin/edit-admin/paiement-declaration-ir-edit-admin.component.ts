...
@Component({
  selector: 'app-paiement-declaration-ir-edit-admin',
  templateUrl: './paiement-declaration-ir-edit-admin.component.html',
  styleUrls: ['./paiement-declaration-ir-edit-admin.component.css']
})
export class PaiementDeclarationIrEditAdminComponent implements OnInit {
