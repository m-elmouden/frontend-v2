...
@Component({
  selector: 'app-paiement-declaration-ir-list-admin',
  templateUrl: './paiement-declaration-ir-list-admin.component.html',
  styleUrls: ['./paiement-declaration-ir-list-admin.component.css']
})
export class PaiementDeclarationIrListAdminComponent implements OnInit {
   // declarations
