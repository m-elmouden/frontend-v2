...
@Component({
  selector: 'app-prelevement-social-list-admin',
  templateUrl: './prelevement-social-list-admin.component.html',
  styleUrls: ['./prelevement-social-list-admin.component.css']
})
export class PrelevementSocialListAdminComponent implements OnInit {
   // declarations
