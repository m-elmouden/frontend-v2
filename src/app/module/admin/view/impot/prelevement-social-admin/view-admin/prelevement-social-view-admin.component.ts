...
@Component({
  selector: 'app-prelevement-social-view-admin',
  templateUrl: './prelevement-social-view-admin.component.html',
  styleUrls: ['./prelevement-social-view-admin.component.css']
})
export class PrelevementSocialViewAdminComponent implements OnInit {
