...
@Component({
  selector: 'app-prelevement-social-create-admin',
  templateUrl: './prelevement-social-create-admin.component.html',
  styleUrls: ['./prelevement-social-create-admin.component.css']
})
export class PrelevementSocialCreateAdminComponent implements OnInit {
