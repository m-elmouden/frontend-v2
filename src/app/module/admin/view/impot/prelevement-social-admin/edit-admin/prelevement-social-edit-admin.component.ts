...
@Component({
  selector: 'app-prelevement-social-edit-admin',
  templateUrl: './prelevement-social-edit-admin.component.html',
  styleUrls: ['./prelevement-social-edit-admin.component.css']
})
export class PrelevementSocialEditAdminComponent implements OnInit {
