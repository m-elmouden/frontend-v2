...
@Component({
  selector: 'app-president-societe-list-admin',
  templateUrl: './president-societe-list-admin.component.html',
  styleUrls: ['./president-societe-list-admin.component.css']
})
export class PresidentSocieteListAdminComponent implements OnInit {
   // declarations
