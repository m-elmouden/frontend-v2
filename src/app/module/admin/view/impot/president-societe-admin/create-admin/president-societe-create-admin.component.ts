...
@Component({
  selector: 'app-president-societe-create-admin',
  templateUrl: './president-societe-create-admin.component.html',
  styleUrls: ['./president-societe-create-admin.component.css']
})
export class PresidentSocieteCreateAdminComponent implements OnInit {
