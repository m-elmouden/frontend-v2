...
@Component({
  selector: 'app-president-societe-view-admin',
  templateUrl: './president-societe-view-admin.component.html',
  styleUrls: ['./president-societe-view-admin.component.css']
})
export class PresidentSocieteViewAdminComponent implements OnInit {
