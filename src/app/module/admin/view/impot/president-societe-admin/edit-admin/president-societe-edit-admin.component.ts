...
@Component({
  selector: 'app-president-societe-edit-admin',
  templateUrl: './president-societe-edit-admin.component.html',
  styleUrls: ['./president-societe-edit-admin.component.css']
})
export class PresidentSocieteEditAdminComponent implements OnInit {
