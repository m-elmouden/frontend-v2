...
@Component({
  selector: 'app-etat-facture-view-admin',
  templateUrl: './etat-facture-view-admin.component.html',
  styleUrls: ['./etat-facture-view-admin.component.css']
})
export class EtatFactureViewAdminComponent implements OnInit {
