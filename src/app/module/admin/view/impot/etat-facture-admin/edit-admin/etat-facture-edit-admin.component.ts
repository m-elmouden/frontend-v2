...
@Component({
  selector: 'app-etat-facture-edit-admin',
  templateUrl: './etat-facture-edit-admin.component.html',
  styleUrls: ['./etat-facture-edit-admin.component.css']
})
export class EtatFactureEditAdminComponent implements OnInit {
