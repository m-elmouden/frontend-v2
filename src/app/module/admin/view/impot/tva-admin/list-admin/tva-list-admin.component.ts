...
@Component({
  selector: 'app-tva-list-admin',
  templateUrl: './tva-list-admin.component.html',
  styleUrls: ['./tva-list-admin.component.css']
})
export class TvaListAdminComponent implements OnInit {
   // declarations
