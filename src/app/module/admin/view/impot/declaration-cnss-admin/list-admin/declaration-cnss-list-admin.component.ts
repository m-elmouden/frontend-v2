...
@Component({
  selector: 'app-declaration-cnss-list-admin',
  templateUrl: './declaration-cnss-list-admin.component.html',
  styleUrls: ['./declaration-cnss-list-admin.component.css']
})
export class DeclarationCnssListAdminComponent implements OnInit {
   // declarations
