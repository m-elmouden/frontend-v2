...
@Component({
  selector: 'app-declaration-cnss-create-admin',
  templateUrl: './declaration-cnss-create-admin.component.html',
  styleUrls: ['./declaration-cnss-create-admin.component.css']
})
export class DeclarationCnssCreateAdminComponent implements OnInit {
