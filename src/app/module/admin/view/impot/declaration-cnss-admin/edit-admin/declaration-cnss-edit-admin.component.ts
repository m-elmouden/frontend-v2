...
@Component({
  selector: 'app-declaration-cnss-edit-admin',
  templateUrl: './declaration-cnss-edit-admin.component.html',
  styleUrls: ['./declaration-cnss-edit-admin.component.css']
})
export class DeclarationCnssEditAdminComponent implements OnInit {
