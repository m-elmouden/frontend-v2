...
@Component({
  selector: 'app-type-taux-cnss-view-admin',
  templateUrl: './type-taux-cnss-view-admin.component.html',
  styleUrls: ['./type-taux-cnss-view-admin.component.css']
})
export class TypeTauxCnssViewAdminComponent implements OnInit {
