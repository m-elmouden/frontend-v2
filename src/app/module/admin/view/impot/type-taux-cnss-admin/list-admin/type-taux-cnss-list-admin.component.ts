...
@Component({
  selector: 'app-type-taux-cnss-list-admin',
  templateUrl: './type-taux-cnss-list-admin.component.html',
  styleUrls: ['./type-taux-cnss-list-admin.component.css']
})
export class TypeTauxCnssListAdminComponent implements OnInit {
   // declarations
