...
@Component({
  selector: 'app-type-taux-cnss-edit-admin',
  templateUrl: './type-taux-cnss-edit-admin.component.html',
  styleUrls: ['./type-taux-cnss-edit-admin.component.css']
})
export class TypeTauxCnssEditAdminComponent implements OnInit {
