...
@Component({
  selector: 'app-type-declaration-tva-edit-admin',
  templateUrl: './type-declaration-tva-edit-admin.component.html',
  styleUrls: ['./type-declaration-tva-edit-admin.component.css']
})
export class TypeDeclarationTvaEditAdminComponent implements OnInit {
