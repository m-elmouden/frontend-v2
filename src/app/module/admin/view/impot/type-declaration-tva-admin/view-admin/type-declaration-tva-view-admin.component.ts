...
@Component({
  selector: 'app-type-declaration-tva-view-admin',
  templateUrl: './type-declaration-tva-view-admin.component.html',
  styleUrls: ['./type-declaration-tva-view-admin.component.css']
})
export class TypeDeclarationTvaViewAdminComponent implements OnInit {
