...
@Component({
  selector: 'app-acompte-edit-admin',
  templateUrl: './acompte-edit-admin.component.html',
  styleUrls: ['./acompte-edit-admin.component.css']
})
export class AcompteEditAdminComponent implements OnInit {
