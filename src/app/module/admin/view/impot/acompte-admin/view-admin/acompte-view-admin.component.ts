...
@Component({
  selector: 'app-acompte-view-admin',
  templateUrl: './acompte-view-admin.component.html',
  styleUrls: ['./acompte-view-admin.component.css']
})
export class AcompteViewAdminComponent implements OnInit {
