...
@Component({
  selector: 'app-taux-cnss-list-admin',
  templateUrl: './taux-cnss-list-admin.component.html',
  styleUrls: ['./taux-cnss-list-admin.component.css']
})
export class TauxCnssListAdminComponent implements OnInit {
   // declarations
