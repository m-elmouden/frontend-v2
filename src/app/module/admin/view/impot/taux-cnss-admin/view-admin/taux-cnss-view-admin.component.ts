...
@Component({
  selector: 'app-taux-cnss-view-admin',
  templateUrl: './taux-cnss-view-admin.component.html',
  styleUrls: ['./taux-cnss-view-admin.component.css']
})
export class TauxCnssViewAdminComponent implements OnInit {
