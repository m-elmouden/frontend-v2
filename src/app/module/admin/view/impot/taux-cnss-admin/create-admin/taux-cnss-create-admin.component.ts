...
@Component({
  selector: 'app-taux-cnss-create-admin',
  templateUrl: './taux-cnss-create-admin.component.html',
  styleUrls: ['./taux-cnss-create-admin.component.css']
})
export class TauxCnssCreateAdminComponent implements OnInit {
