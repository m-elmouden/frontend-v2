...
@Component({
  selector: 'app-etat-declaration-is-create-admin',
  templateUrl: './etat-declaration-is-create-admin.component.html',
  styleUrls: ['./etat-declaration-is-create-admin.component.css']
})
export class EtatDeclarationIsCreateAdminComponent implements OnInit {
