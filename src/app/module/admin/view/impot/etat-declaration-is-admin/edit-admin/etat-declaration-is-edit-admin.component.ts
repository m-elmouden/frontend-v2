...
@Component({
  selector: 'app-etat-declaration-is-edit-admin',
  templateUrl: './etat-declaration-is-edit-admin.component.html',
  styleUrls: ['./etat-declaration-is-edit-admin.component.css']
})
export class EtatDeclarationIsEditAdminComponent implements OnInit {
