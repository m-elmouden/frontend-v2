...
@Component({
  selector: 'app-etat-declaration-is-list-admin',
  templateUrl: './etat-declaration-is-list-admin.component.html',
  styleUrls: ['./etat-declaration-is-list-admin.component.css']
})
export class EtatDeclarationIsListAdminComponent implements OnInit {
   // declarations
