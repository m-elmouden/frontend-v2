...
@Component({
  selector: 'app-paiement-declaration-tva-list-admin',
  templateUrl: './paiement-declaration-tva-list-admin.component.html',
  styleUrls: ['./paiement-declaration-tva-list-admin.component.css']
})
export class PaiementDeclarationTvaListAdminComponent implements OnInit {
   // declarations
