...
@Component({
  selector: 'app-paiement-declaration-tva-edit-admin',
  templateUrl: './paiement-declaration-tva-edit-admin.component.html',
  styleUrls: ['./paiement-declaration-tva-edit-admin.component.css']
})
export class PaiementDeclarationTvaEditAdminComponent implements OnInit {
