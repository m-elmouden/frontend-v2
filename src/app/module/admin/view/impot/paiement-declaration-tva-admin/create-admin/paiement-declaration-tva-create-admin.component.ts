...
@Component({
  selector: 'app-paiement-declaration-tva-create-admin',
  templateUrl: './paiement-declaration-tva-create-admin.component.html',
  styleUrls: ['./paiement-declaration-tva-create-admin.component.css']
})
export class PaiementDeclarationTvaCreateAdminComponent implements OnInit {
