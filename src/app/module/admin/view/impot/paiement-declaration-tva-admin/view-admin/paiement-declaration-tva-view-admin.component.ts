...
@Component({
  selector: 'app-paiement-declaration-tva-view-admin',
  templateUrl: './paiement-declaration-tva-view-admin.component.html',
  styleUrls: ['./paiement-declaration-tva-view-admin.component.css']
})
export class PaiementDeclarationTvaViewAdminComponent implements OnInit {
