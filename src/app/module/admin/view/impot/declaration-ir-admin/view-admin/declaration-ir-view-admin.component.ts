...
@Component({
  selector: 'app-declaration-ir-view-admin',
  templateUrl: './declaration-ir-view-admin.component.html',
  styleUrls: ['./declaration-ir-view-admin.component.css']
})
export class DeclarationIrViewAdminComponent implements OnInit {
