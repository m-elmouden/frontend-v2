...
@Component({
  selector: 'app-classe-comptable-edit-admin',
  templateUrl: './classe-comptable-edit-admin.component.html',
  styleUrls: ['./classe-comptable-edit-admin.component.css']
})
export class ClasseComptableEditAdminComponent implements OnInit {
