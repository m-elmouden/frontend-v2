...
@Component({
  selector: 'app-classe-comptable-view-admin',
  templateUrl: './classe-comptable-view-admin.component.html',
  styleUrls: ['./classe-comptable-view-admin.component.css']
})
export class ClasseComptableViewAdminComponent implements OnInit {
