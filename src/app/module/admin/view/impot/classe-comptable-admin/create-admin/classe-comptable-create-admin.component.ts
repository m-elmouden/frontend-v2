...
@Component({
  selector: 'app-classe-comptable-create-admin',
  templateUrl: './classe-comptable-create-admin.component.html',
  styleUrls: ['./classe-comptable-create-admin.component.css']
})
export class ClasseComptableCreateAdminComponent implements OnInit {
