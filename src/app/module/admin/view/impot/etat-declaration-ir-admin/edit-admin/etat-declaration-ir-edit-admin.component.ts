...
@Component({
  selector: 'app-etat-declaration-ir-edit-admin',
  templateUrl: './etat-declaration-ir-edit-admin.component.html',
  styleUrls: ['./etat-declaration-ir-edit-admin.component.css']
})
export class EtatDeclarationIrEditAdminComponent implements OnInit {
