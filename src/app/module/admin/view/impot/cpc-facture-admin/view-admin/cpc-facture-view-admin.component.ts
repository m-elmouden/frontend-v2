...
@Component({
  selector: 'app-cpc-facture-view-admin',
  templateUrl: './cpc-facture-view-admin.component.html',
  styleUrls: ['./cpc-facture-view-admin.component.css']
})
export class CpcFactureViewAdminComponent implements OnInit {
