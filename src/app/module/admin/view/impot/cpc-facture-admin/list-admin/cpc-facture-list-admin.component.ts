...
@Component({
  selector: 'app-cpc-facture-list-admin',
  templateUrl: './cpc-facture-list-admin.component.html',
  styleUrls: ['./cpc-facture-list-admin.component.css']
})
export class CpcFactureListAdminComponent implements OnInit {
   // declarations
