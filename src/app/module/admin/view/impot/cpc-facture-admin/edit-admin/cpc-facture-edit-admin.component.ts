...
@Component({
  selector: 'app-cpc-facture-edit-admin',
  templateUrl: './cpc-facture-edit-admin.component.html',
  styleUrls: ['./cpc-facture-edit-admin.component.css']
})
export class CpcFactureEditAdminComponent implements OnInit {
