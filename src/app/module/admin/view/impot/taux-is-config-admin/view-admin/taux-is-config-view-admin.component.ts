...
@Component({
  selector: 'app-taux-is-config-view-admin',
  templateUrl: './taux-is-config-view-admin.component.html',
  styleUrls: ['./taux-is-config-view-admin.component.css']
})
export class TauxIsConfigViewAdminComponent implements OnInit {
