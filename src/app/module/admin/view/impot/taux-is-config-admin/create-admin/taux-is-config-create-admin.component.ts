...
@Component({
  selector: 'app-taux-is-config-create-admin',
  templateUrl: './taux-is-config-create-admin.component.html',
  styleUrls: ['./taux-is-config-create-admin.component.css']
})
export class TauxIsConfigCreateAdminComponent implements OnInit {
