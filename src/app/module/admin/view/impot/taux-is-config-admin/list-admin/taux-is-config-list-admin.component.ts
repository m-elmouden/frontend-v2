...
@Component({
  selector: 'app-taux-is-config-list-admin',
  templateUrl: './taux-is-config-list-admin.component.html',
  styleUrls: ['./taux-is-config-list-admin.component.css']
})
export class TauxIsConfigListAdminComponent implements OnInit {
   // declarations
