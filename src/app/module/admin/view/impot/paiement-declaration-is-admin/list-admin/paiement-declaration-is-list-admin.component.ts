...
@Component({
  selector: 'app-paiement-declaration-is-list-admin',
  templateUrl: './paiement-declaration-is-list-admin.component.html',
  styleUrls: ['./paiement-declaration-is-list-admin.component.css']
})
export class PaiementDeclarationIsListAdminComponent implements OnInit {
   // declarations
