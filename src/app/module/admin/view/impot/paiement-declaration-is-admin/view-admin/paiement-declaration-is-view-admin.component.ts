...
@Component({
  selector: 'app-paiement-declaration-is-view-admin',
  templateUrl: './paiement-declaration-is-view-admin.component.html',
  styleUrls: ['./paiement-declaration-is-view-admin.component.css']
})
export class PaiementDeclarationIsViewAdminComponent implements OnInit {
