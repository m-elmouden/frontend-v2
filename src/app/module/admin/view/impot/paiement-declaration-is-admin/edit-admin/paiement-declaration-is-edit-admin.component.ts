...
@Component({
  selector: 'app-paiement-declaration-is-edit-admin',
  templateUrl: './paiement-declaration-is-edit-admin.component.html',
  styleUrls: ['./paiement-declaration-is-edit-admin.component.css']
})
export class PaiementDeclarationIsEditAdminComponent implements OnInit {
