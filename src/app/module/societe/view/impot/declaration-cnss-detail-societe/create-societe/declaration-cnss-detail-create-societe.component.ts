...
@Component({
  selector: 'app-declaration-cnss-detail-create-societe',
  templateUrl: './declaration-cnss-detail-create-societe.component.html',
  styleUrls: ['./declaration-cnss-detail-create-societe.component.css']
})
export class DeclarationCnssDetailCreateSocieteComponent implements OnInit {
