...
@Component({
  selector: 'app-declaration-cnss-detail-list-societe',
  templateUrl: './declaration-cnss-detail-list-societe.component.html',
  styleUrls: ['./declaration-cnss-detail-list-societe.component.css']
})
export class DeclarationCnssDetailListSocieteComponent implements OnInit {
   // declarations
