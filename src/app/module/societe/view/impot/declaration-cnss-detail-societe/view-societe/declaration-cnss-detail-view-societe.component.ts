...
@Component({
  selector: 'app-declaration-cnss-detail-view-societe',
  templateUrl: './declaration-cnss-detail-view-societe.component.html',
  styleUrls: ['./declaration-cnss-detail-view-societe.component.css']
})
export class DeclarationCnssDetailViewSocieteComponent implements OnInit {
