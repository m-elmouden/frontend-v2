...
@Component({
  selector: 'app-declaration-cnss-detail-edit-societe',
  templateUrl: './declaration-cnss-detail-edit-societe.component.html',
  styleUrls: ['./declaration-cnss-detail-edit-societe.component.css']
})
export class DeclarationCnssDetailEditSocieteComponent implements OnInit {
