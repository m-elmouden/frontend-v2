...
@Component({
  selector: 'app-employe-edit-societe',
  templateUrl: './employe-edit-societe.component.html',
  styleUrls: ['./employe-edit-societe.component.css']
})
export class EmployeEditSocieteComponent implements OnInit {
