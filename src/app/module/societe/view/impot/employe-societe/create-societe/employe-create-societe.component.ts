...
@Component({
  selector: 'app-employe-create-societe',
  templateUrl: './employe-create-societe.component.html',
  styleUrls: ['./employe-create-societe.component.css']
})
export class EmployeCreateSocieteComponent implements OnInit {
