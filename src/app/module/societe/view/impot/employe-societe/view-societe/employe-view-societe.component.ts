...
@Component({
  selector: 'app-employe-view-societe',
  templateUrl: './employe-view-societe.component.html',
  styleUrls: ['./employe-view-societe.component.css']
})
export class EmployeViewSocieteComponent implements OnInit {
