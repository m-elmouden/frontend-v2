...
@Component({
  selector: 'app-acompte-list-societe',
  templateUrl: './acompte-list-societe.component.html',
  styleUrls: ['./acompte-list-societe.component.css']
})
export class AcompteListSocieteComponent implements OnInit {
   // declarations
