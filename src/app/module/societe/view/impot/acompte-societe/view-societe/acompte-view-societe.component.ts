...
@Component({
  selector: 'app-acompte-view-societe',
  templateUrl: './acompte-view-societe.component.html',
  styleUrls: ['./acompte-view-societe.component.css']
})
export class AcompteViewSocieteComponent implements OnInit {
