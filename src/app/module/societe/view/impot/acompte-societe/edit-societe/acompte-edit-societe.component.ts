...
@Component({
  selector: 'app-acompte-edit-societe',
  templateUrl: './acompte-edit-societe.component.html',
  styleUrls: ['./acompte-edit-societe.component.css']
})
export class AcompteEditSocieteComponent implements OnInit {
