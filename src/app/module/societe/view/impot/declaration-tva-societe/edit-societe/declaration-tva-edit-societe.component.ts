...
@Component({
  selector: 'app-declaration-tva-edit-societe',
  templateUrl: './declaration-tva-edit-societe.component.html',
  styleUrls: ['./declaration-tva-edit-societe.component.css']
})
export class DeclarationTvaEditSocieteComponent implements OnInit {
