...
@Component({
  selector: 'app-declaration-tva-view-societe',
  templateUrl: './declaration-tva-view-societe.component.html',
  styleUrls: ['./declaration-tva-view-societe.component.css']
})
export class DeclarationTvaViewSocieteComponent implements OnInit {
