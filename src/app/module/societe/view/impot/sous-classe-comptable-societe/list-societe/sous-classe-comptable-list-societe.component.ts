...
@Component({
  selector: 'app-sous-classe-comptable-list-societe',
  templateUrl: './sous-classe-comptable-list-societe.component.html',
  styleUrls: ['./sous-classe-comptable-list-societe.component.css']
})
export class SousClasseComptableListSocieteComponent implements OnInit {
   // declarations
