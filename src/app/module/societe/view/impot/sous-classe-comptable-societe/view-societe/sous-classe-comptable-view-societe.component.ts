...
@Component({
  selector: 'app-sous-classe-comptable-view-societe',
  templateUrl: './sous-classe-comptable-view-societe.component.html',
  styleUrls: ['./sous-classe-comptable-view-societe.component.css']
})
export class SousClasseComptableViewSocieteComponent implements OnInit {
