...
@Component({
  selector: 'app-sous-classe-comptable-edit-societe',
  templateUrl: './sous-classe-comptable-edit-societe.component.html',
  styleUrls: ['./sous-classe-comptable-edit-societe.component.css']
})
export class SousClasseComptableEditSocieteComponent implements OnInit {
