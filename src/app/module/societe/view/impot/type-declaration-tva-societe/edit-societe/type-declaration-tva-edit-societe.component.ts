...
@Component({
  selector: 'app-type-declaration-tva-edit-societe',
  templateUrl: './type-declaration-tva-edit-societe.component.html',
  styleUrls: ['./type-declaration-tva-edit-societe.component.css']
})
export class TypeDeclarationTvaEditSocieteComponent implements OnInit {
