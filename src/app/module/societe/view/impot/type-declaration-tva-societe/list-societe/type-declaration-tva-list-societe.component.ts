...
@Component({
  selector: 'app-type-declaration-tva-list-societe',
  templateUrl: './type-declaration-tva-list-societe.component.html',
  styleUrls: ['./type-declaration-tva-list-societe.component.css']
})
export class TypeDeclarationTvaListSocieteComponent implements OnInit {
   // declarations
