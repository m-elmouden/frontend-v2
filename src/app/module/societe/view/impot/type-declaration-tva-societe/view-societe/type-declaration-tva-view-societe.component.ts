...
@Component({
  selector: 'app-type-declaration-tva-view-societe',
  templateUrl: './type-declaration-tva-view-societe.component.html',
  styleUrls: ['./type-declaration-tva-view-societe.component.css']
})
export class TypeDeclarationTvaViewSocieteComponent implements OnInit {
