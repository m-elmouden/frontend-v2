...
@Component({
  selector: 'app-type-declaration-tva-create-societe',
  templateUrl: './type-declaration-tva-create-societe.component.html',
  styleUrls: ['./type-declaration-tva-create-societe.component.css']
})
export class TypeDeclarationTvaCreateSocieteComponent implements OnInit {
