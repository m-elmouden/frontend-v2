...
@Component({
  selector: 'app-declaration-cnss-list-societe',
  templateUrl: './declaration-cnss-list-societe.component.html',
  styleUrls: ['./declaration-cnss-list-societe.component.css']
})
export class DeclarationCnssListSocieteComponent implements OnInit {
   // declarations
