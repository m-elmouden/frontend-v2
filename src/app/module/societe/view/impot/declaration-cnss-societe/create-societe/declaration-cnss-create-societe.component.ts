...
@Component({
  selector: 'app-declaration-cnss-create-societe',
  templateUrl: './declaration-cnss-create-societe.component.html',
  styleUrls: ['./declaration-cnss-create-societe.component.css']
})
export class DeclarationCnssCreateSocieteComponent implements OnInit {
