...
@Component({
  selector: 'app-declaration-cnss-view-societe',
  templateUrl: './declaration-cnss-view-societe.component.html',
  styleUrls: ['./declaration-cnss-view-societe.component.css']
})
export class DeclarationCnssViewSocieteComponent implements OnInit {
