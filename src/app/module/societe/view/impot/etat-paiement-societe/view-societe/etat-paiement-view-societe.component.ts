...
@Component({
  selector: 'app-etat-paiement-view-societe',
  templateUrl: './etat-paiement-view-societe.component.html',
  styleUrls: ['./etat-paiement-view-societe.component.css']
})
export class EtatPaiementViewSocieteComponent implements OnInit {
