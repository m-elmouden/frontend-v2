...
@Component({
  selector: 'app-etat-paiement-list-societe',
  templateUrl: './etat-paiement-list-societe.component.html',
  styleUrls: ['./etat-paiement-list-societe.component.css']
})
export class EtatPaiementListSocieteComponent implements OnInit {
   // declarations
