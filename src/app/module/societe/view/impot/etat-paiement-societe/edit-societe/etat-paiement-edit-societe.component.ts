...
@Component({
  selector: 'app-etat-paiement-edit-societe',
  templateUrl: './etat-paiement-edit-societe.component.html',
  styleUrls: ['./etat-paiement-edit-societe.component.css']
})
export class EtatPaiementEditSocieteComponent implements OnInit {
