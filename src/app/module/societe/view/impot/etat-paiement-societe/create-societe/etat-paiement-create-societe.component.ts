...
@Component({
  selector: 'app-etat-paiement-create-societe',
  templateUrl: './etat-paiement-create-societe.component.html',
  styleUrls: ['./etat-paiement-create-societe.component.css']
})
export class EtatPaiementCreateSocieteComponent implements OnInit {
