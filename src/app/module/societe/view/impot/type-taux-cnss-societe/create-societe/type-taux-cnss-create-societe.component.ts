...
@Component({
  selector: 'app-type-taux-cnss-create-societe',
  templateUrl: './type-taux-cnss-create-societe.component.html',
  styleUrls: ['./type-taux-cnss-create-societe.component.css']
})
export class TypeTauxCnssCreateSocieteComponent implements OnInit {
