...
@Component({
  selector: 'app-type-taux-cnss-list-societe',
  templateUrl: './type-taux-cnss-list-societe.component.html',
  styleUrls: ['./type-taux-cnss-list-societe.component.css']
})
export class TypeTauxCnssListSocieteComponent implements OnInit {
   // declarations
