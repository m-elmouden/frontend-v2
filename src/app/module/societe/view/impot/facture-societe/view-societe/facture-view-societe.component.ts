...
@Component({
  selector: 'app-facture-view-societe',
  templateUrl: './facture-view-societe.component.html',
  styleUrls: ['./facture-view-societe.component.css']
})
export class FactureViewSocieteComponent implements OnInit {
