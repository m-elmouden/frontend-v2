...
@Component({
  selector: 'app-facture-list-societe',
  templateUrl: './facture-list-societe.component.html',
  styleUrls: ['./facture-list-societe.component.css']
})
export class FactureListSocieteComponent implements OnInit {
   // declarations
