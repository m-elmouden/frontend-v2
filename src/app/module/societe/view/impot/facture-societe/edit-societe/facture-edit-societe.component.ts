...
@Component({
  selector: 'app-facture-edit-societe',
  templateUrl: './facture-edit-societe.component.html',
  styleUrls: ['./facture-edit-societe.component.css']
})
export class FactureEditSocieteComponent implements OnInit {
