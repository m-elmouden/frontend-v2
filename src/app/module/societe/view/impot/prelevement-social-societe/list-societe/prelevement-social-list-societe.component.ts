...
@Component({
  selector: 'app-prelevement-social-list-societe',
  templateUrl: './prelevement-social-list-societe.component.html',
  styleUrls: ['./prelevement-social-list-societe.component.css']
})
export class PrelevementSocialListSocieteComponent implements OnInit {
   // declarations
