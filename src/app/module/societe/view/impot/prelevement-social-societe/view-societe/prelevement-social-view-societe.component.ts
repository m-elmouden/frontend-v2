...
@Component({
  selector: 'app-prelevement-social-view-societe',
  templateUrl: './prelevement-social-view-societe.component.html',
  styleUrls: ['./prelevement-social-view-societe.component.css']
})
export class PrelevementSocialViewSocieteComponent implements OnInit {
