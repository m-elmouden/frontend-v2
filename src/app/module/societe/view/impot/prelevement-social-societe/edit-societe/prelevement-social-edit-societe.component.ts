...
@Component({
  selector: 'app-prelevement-social-edit-societe',
  templateUrl: './prelevement-social-edit-societe.component.html',
  styleUrls: ['./prelevement-social-edit-societe.component.css']
})
export class PrelevementSocialEditSocieteComponent implements OnInit {
