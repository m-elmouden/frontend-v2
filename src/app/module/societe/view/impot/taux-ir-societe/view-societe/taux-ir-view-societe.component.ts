...
@Component({
  selector: 'app-taux-ir-view-societe',
  templateUrl: './taux-ir-view-societe.component.html',
  styleUrls: ['./taux-ir-view-societe.component.css']
})
export class TauxIrViewSocieteComponent implements OnInit {
