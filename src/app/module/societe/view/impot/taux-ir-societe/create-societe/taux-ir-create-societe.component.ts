...
@Component({
  selector: 'app-taux-ir-create-societe',
  templateUrl: './taux-ir-create-societe.component.html',
  styleUrls: ['./taux-ir-create-societe.component.css']
})
export class TauxIrCreateSocieteComponent implements OnInit {
