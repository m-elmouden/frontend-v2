...
@Component({
  selector: 'app-taux-ir-list-societe',
  templateUrl: './taux-ir-list-societe.component.html',
  styleUrls: ['./taux-ir-list-societe.component.css']
})
export class TauxIrListSocieteComponent implements OnInit {
   // declarations
