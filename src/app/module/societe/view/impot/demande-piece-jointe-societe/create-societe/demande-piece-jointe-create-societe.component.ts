...
@Component({
  selector: 'app-demande-piece-jointe-create-societe',
  templateUrl: './demande-piece-jointe-create-societe.component.html',
  styleUrls: ['./demande-piece-jointe-create-societe.component.css']
})
export class DemandePieceJointeCreateSocieteComponent implements OnInit {
