...
@Component({
  selector: 'app-demande-piece-jointe-edit-societe',
  templateUrl: './demande-piece-jointe-edit-societe.component.html',
  styleUrls: ['./demande-piece-jointe-edit-societe.component.css']
})
export class DemandePieceJointeEditSocieteComponent implements OnInit {
