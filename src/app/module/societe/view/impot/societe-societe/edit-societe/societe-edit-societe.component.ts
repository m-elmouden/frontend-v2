...
@Component({
  selector: 'app-societe-edit-societe',
  templateUrl: './societe-edit-societe.component.html',
  styleUrls: ['./societe-edit-societe.component.css']
})
export class SocieteEditSocieteComponent implements OnInit {
