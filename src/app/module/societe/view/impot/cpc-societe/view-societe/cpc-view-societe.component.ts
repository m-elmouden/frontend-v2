...
@Component({
  selector: 'app-cpc-view-societe',
  templateUrl: './cpc-view-societe.component.html',
  styleUrls: ['./cpc-view-societe.component.css']
})
export class CpcViewSocieteComponent implements OnInit {
