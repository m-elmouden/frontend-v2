...
@Component({
  selector: 'app-cpc-list-societe',
  templateUrl: './cpc-list-societe.component.html',
  styleUrls: ['./cpc-list-societe.component.css']
})
export class CpcListSocieteComponent implements OnInit {
   // declarations
