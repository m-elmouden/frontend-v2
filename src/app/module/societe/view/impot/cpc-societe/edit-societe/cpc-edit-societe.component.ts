...
@Component({
  selector: 'app-cpc-edit-societe',
  templateUrl: './cpc-edit-societe.component.html',
  styleUrls: ['./cpc-edit-societe.component.css']
})
export class CpcEditSocieteComponent implements OnInit {
