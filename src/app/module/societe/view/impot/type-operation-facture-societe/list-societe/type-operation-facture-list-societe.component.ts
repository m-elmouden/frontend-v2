...
@Component({
  selector: 'app-type-operation-facture-list-societe',
  templateUrl: './type-operation-facture-list-societe.component.html',
  styleUrls: ['./type-operation-facture-list-societe.component.css']
})
export class TypeOperationFactureListSocieteComponent implements OnInit {
   // declarations
