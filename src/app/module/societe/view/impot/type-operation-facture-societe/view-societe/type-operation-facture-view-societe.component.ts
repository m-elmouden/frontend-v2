...
@Component({
  selector: 'app-type-operation-facture-view-societe',
  templateUrl: './type-operation-facture-view-societe.component.html',
  styleUrls: ['./type-operation-facture-view-societe.component.css']
})
export class TypeOperationFactureViewSocieteComponent implements OnInit {
