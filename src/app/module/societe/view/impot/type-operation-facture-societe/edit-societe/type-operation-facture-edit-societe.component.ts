...
@Component({
  selector: 'app-type-operation-facture-edit-societe',
  templateUrl: './type-operation-facture-edit-societe.component.html',
  styleUrls: ['./type-operation-facture-edit-societe.component.css']
})
export class TypeOperationFactureEditSocieteComponent implements OnInit {
