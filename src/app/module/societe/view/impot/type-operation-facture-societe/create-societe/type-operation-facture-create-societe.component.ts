...
@Component({
  selector: 'app-type-operation-facture-create-societe',
  templateUrl: './type-operation-facture-create-societe.component.html',
  styleUrls: ['./type-operation-facture-create-societe.component.css']
})
export class TypeOperationFactureCreateSocieteComponent implements OnInit {
