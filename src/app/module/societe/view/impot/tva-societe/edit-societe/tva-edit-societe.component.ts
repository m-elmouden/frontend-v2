...
@Component({
  selector: 'app-tva-edit-societe',
  templateUrl: './tva-edit-societe.component.html',
  styleUrls: ['./tva-edit-societe.component.css']
})
export class TvaEditSocieteComponent implements OnInit {
