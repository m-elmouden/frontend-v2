...
@Component({
  selector: 'app-tva-view-societe',
  templateUrl: './tva-view-societe.component.html',
  styleUrls: ['./tva-view-societe.component.css']
})
export class TvaViewSocieteComponent implements OnInit {
