...
@Component({
  selector: 'app-tva-list-societe',
  templateUrl: './tva-list-societe.component.html',
  styleUrls: ['./tva-list-societe.component.css']
})
export class TvaListSocieteComponent implements OnInit {
   // declarations
