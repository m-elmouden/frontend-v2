...
@Component({
  selector: 'app-president-societe-edit-societe',
  templateUrl: './president-societe-edit-societe.component.html',
  styleUrls: ['./president-societe-edit-societe.component.css']
})
export class PresidentSocieteEditSocieteComponent implements OnInit {
