...
@Component({
  selector: 'app-president-societe-list-societe',
  templateUrl: './president-societe-list-societe.component.html',
  styleUrls: ['./president-societe-list-societe.component.css']
})
export class PresidentSocieteListSocieteComponent implements OnInit {
   // declarations
