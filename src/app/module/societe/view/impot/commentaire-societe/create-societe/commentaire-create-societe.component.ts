...
@Component({
  selector: 'app-commentaire-create-societe',
  templateUrl: './commentaire-create-societe.component.html',
  styleUrls: ['./commentaire-create-societe.component.css']
})
export class CommentaireCreateSocieteComponent implements OnInit {
