...
@Component({
  selector: 'app-commentaire-view-societe',
  templateUrl: './commentaire-view-societe.component.html',
  styleUrls: ['./commentaire-view-societe.component.css']
})
export class CommentaireViewSocieteComponent implements OnInit {
