...
@Component({
  selector: 'app-commentaire-list-societe',
  templateUrl: './commentaire-list-societe.component.html',
  styleUrls: ['./commentaire-list-societe.component.css']
})
export class CommentaireListSocieteComponent implements OnInit {
   // declarations
