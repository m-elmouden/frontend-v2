...
@Component({
  selector: 'app-comptable-create-societe',
  templateUrl: './comptable-create-societe.component.html',
  styleUrls: ['./comptable-create-societe.component.css']
})
export class ComptableCreateSocieteComponent implements OnInit {
