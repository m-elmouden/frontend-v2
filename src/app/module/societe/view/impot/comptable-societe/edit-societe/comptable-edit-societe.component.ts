...
@Component({
  selector: 'app-comptable-edit-societe',
  templateUrl: './comptable-edit-societe.component.html',
  styleUrls: ['./comptable-edit-societe.component.css']
})
export class ComptableEditSocieteComponent implements OnInit {
