...
@Component({
  selector: 'app-comptable-list-societe',
  templateUrl: './comptable-list-societe.component.html',
  styleUrls: ['./comptable-list-societe.component.css']
})
export class ComptableListSocieteComponent implements OnInit {
   // declarations
