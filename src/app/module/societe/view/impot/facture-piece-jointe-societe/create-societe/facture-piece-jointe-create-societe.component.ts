...
@Component({
  selector: 'app-facture-piece-jointe-create-societe',
  templateUrl: './facture-piece-jointe-create-societe.component.html',
  styleUrls: ['./facture-piece-jointe-create-societe.component.css']
})
export class FacturePieceJointeCreateSocieteComponent implements OnInit {
