...
@Component({
  selector: 'app-facture-piece-jointe-view-societe',
  templateUrl: './facture-piece-jointe-view-societe.component.html',
  styleUrls: ['./facture-piece-jointe-view-societe.component.css']
})
export class FacturePieceJointeViewSocieteComponent implements OnInit {
