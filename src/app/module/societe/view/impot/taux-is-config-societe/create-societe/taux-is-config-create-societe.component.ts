...
@Component({
  selector: 'app-taux-is-config-create-societe',
  templateUrl: './taux-is-config-create-societe.component.html',
  styleUrls: ['./taux-is-config-create-societe.component.css']
})
export class TauxIsConfigCreateSocieteComponent implements OnInit {
