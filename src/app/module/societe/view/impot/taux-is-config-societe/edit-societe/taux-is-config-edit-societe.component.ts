...
@Component({
  selector: 'app-taux-is-config-edit-societe',
  templateUrl: './taux-is-config-edit-societe.component.html',
  styleUrls: ['./taux-is-config-edit-societe.component.css']
})
export class TauxIsConfigEditSocieteComponent implements OnInit {
