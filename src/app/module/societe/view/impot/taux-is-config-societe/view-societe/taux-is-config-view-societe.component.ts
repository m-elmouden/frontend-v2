...
@Component({
  selector: 'app-taux-is-config-view-societe',
  templateUrl: './taux-is-config-view-societe.component.html',
  styleUrls: ['./taux-is-config-view-societe.component.css']
})
export class TauxIsConfigViewSocieteComponent implements OnInit {
