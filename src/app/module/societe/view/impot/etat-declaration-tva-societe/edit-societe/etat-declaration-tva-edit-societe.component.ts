...
@Component({
  selector: 'app-etat-declaration-tva-edit-societe',
  templateUrl: './etat-declaration-tva-edit-societe.component.html',
  styleUrls: ['./etat-declaration-tva-edit-societe.component.css']
})
export class EtatDeclarationTvaEditSocieteComponent implements OnInit {
