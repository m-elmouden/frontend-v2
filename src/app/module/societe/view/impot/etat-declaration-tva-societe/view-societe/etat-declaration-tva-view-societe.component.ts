...
@Component({
  selector: 'app-etat-declaration-tva-view-societe',
  templateUrl: './etat-declaration-tva-view-societe.component.html',
  styleUrls: ['./etat-declaration-tva-view-societe.component.css']
})
export class EtatDeclarationTvaViewSocieteComponent implements OnInit {
