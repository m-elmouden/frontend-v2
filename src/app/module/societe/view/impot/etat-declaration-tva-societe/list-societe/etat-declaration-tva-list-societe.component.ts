...
@Component({
  selector: 'app-etat-declaration-tva-list-societe',
  templateUrl: './etat-declaration-tva-list-societe.component.html',
  styleUrls: ['./etat-declaration-tva-list-societe.component.css']
})
export class EtatDeclarationTvaListSocieteComponent implements OnInit {
   // declarations
