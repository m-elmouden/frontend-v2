...
@Component({
  selector: 'app-declaration-is-create-societe',
  templateUrl: './declaration-is-create-societe.component.html',
  styleUrls: ['./declaration-is-create-societe.component.css']
})
export class DeclarationIsCreateSocieteComponent implements OnInit {
