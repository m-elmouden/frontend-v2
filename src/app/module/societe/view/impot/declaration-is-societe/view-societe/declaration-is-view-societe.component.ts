...
@Component({
  selector: 'app-declaration-is-view-societe',
  templateUrl: './declaration-is-view-societe.component.html',
  styleUrls: ['./declaration-is-view-societe.component.css']
})
export class DeclarationIsViewSocieteComponent implements OnInit {
