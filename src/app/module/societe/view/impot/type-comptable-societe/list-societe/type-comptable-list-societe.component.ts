...
@Component({
  selector: 'app-type-comptable-list-societe',
  templateUrl: './type-comptable-list-societe.component.html',
  styleUrls: ['./type-comptable-list-societe.component.css']
})
export class TypeComptableListSocieteComponent implements OnInit {
   // declarations
