...
@Component({
  selector: 'app-type-comptable-edit-societe',
  templateUrl: './type-comptable-edit-societe.component.html',
  styleUrls: ['./type-comptable-edit-societe.component.css']
})
export class TypeComptableEditSocieteComponent implements OnInit {
