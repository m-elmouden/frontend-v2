...
@Component({
  selector: 'app-type-comptable-view-societe',
  templateUrl: './type-comptable-view-societe.component.html',
  styleUrls: ['./type-comptable-view-societe.component.css']
})
export class TypeComptableViewSocieteComponent implements OnInit {
