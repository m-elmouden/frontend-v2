...
@Component({
  selector: 'app-type-comptable-create-societe',
  templateUrl: './type-comptable-create-societe.component.html',
  styleUrls: ['./type-comptable-create-societe.component.css']
})
export class TypeComptableCreateSocieteComponent implements OnInit {
