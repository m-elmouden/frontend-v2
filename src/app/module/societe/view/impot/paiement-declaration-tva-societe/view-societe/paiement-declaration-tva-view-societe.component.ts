...
@Component({
  selector: 'app-paiement-declaration-tva-view-societe',
  templateUrl: './paiement-declaration-tva-view-societe.component.html',
  styleUrls: ['./paiement-declaration-tva-view-societe.component.css']
})
export class PaiementDeclarationTvaViewSocieteComponent implements OnInit {
