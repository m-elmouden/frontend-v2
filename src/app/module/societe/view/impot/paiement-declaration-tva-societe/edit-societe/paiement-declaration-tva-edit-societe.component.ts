...
@Component({
  selector: 'app-paiement-declaration-tva-edit-societe',
  templateUrl: './paiement-declaration-tva-edit-societe.component.html',
  styleUrls: ['./paiement-declaration-tva-edit-societe.component.css']
})
export class PaiementDeclarationTvaEditSocieteComponent implements OnInit {
