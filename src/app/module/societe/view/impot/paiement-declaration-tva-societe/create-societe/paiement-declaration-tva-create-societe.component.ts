...
@Component({
  selector: 'app-paiement-declaration-tva-create-societe',
  templateUrl: './paiement-declaration-tva-create-societe.component.html',
  styleUrls: ['./paiement-declaration-tva-create-societe.component.css']
})
export class PaiementDeclarationTvaCreateSocieteComponent implements OnInit {
