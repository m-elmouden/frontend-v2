...
@Component({
  selector: 'app-taux-is-create-societe',
  templateUrl: './taux-is-create-societe.component.html',
  styleUrls: ['./taux-is-create-societe.component.css']
})
export class TauxIsCreateSocieteComponent implements OnInit {
