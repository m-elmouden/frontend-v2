...
@Component({
  selector: 'app-taux-is-list-societe',
  templateUrl: './taux-is-list-societe.component.html',
  styleUrls: ['./taux-is-list-societe.component.css']
})
export class TauxIsListSocieteComponent implements OnInit {
   // declarations
