...
@Component({
  selector: 'app-declaration-ir-employe-create-societe',
  templateUrl: './declaration-ir-employe-create-societe.component.html',
  styleUrls: ['./declaration-ir-employe-create-societe.component.css']
})
export class DeclarationIrEmployeCreateSocieteComponent implements OnInit {
