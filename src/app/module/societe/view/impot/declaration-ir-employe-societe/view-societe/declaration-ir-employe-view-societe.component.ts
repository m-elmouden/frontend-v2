...
@Component({
  selector: 'app-declaration-ir-employe-view-societe',
  templateUrl: './declaration-ir-employe-view-societe.component.html',
  styleUrls: ['./declaration-ir-employe-view-societe.component.css']
})
export class DeclarationIrEmployeViewSocieteComponent implements OnInit {
