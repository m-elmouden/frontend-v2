...
@Component({
  selector: 'app-etat-facture-create-societe',
  templateUrl: './etat-facture-create-societe.component.html',
  styleUrls: ['./etat-facture-create-societe.component.css']
})
export class EtatFactureCreateSocieteComponent implements OnInit {
