...
@Component({
  selector: 'app-etat-facture-view-societe',
  templateUrl: './etat-facture-view-societe.component.html',
  styleUrls: ['./etat-facture-view-societe.component.css']
})
export class EtatFactureViewSocieteComponent implements OnInit {
