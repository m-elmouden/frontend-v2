...
@Component({
  selector: 'app-etat-facture-list-societe',
  templateUrl: './etat-facture-list-societe.component.html',
  styleUrls: ['./etat-facture-list-societe.component.css']
})
export class EtatFactureListSocieteComponent implements OnInit {
   // declarations
