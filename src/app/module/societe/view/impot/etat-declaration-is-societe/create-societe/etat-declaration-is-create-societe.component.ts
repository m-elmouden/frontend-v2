...
@Component({
  selector: 'app-etat-declaration-is-create-societe',
  templateUrl: './etat-declaration-is-create-societe.component.html',
  styleUrls: ['./etat-declaration-is-create-societe.component.css']
})
export class EtatDeclarationIsCreateSocieteComponent implements OnInit {
