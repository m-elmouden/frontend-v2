...
@Component({
  selector: 'app-etat-declaration-is-list-societe',
  templateUrl: './etat-declaration-is-list-societe.component.html',
  styleUrls: ['./etat-declaration-is-list-societe.component.css']
})
export class EtatDeclarationIsListSocieteComponent implements OnInit {
   // declarations
