...
@Component({
  selector: 'app-etat-declaration-is-view-societe',
  templateUrl: './etat-declaration-is-view-societe.component.html',
  styleUrls: ['./etat-declaration-is-view-societe.component.css']
})
export class EtatDeclarationIsViewSocieteComponent implements OnInit {
