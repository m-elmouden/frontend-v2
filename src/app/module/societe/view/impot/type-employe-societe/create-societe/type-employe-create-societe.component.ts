...
@Component({
  selector: 'app-type-employe-create-societe',
  templateUrl: './type-employe-create-societe.component.html',
  styleUrls: ['./type-employe-create-societe.component.css']
})
export class TypeEmployeCreateSocieteComponent implements OnInit {
