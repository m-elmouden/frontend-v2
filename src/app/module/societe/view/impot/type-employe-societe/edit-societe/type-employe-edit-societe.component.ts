...
@Component({
  selector: 'app-type-employe-edit-societe',
  templateUrl: './type-employe-edit-societe.component.html',
  styleUrls: ['./type-employe-edit-societe.component.css']
})
export class TypeEmployeEditSocieteComponent implements OnInit {
