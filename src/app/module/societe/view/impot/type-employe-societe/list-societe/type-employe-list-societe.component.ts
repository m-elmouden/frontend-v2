...
@Component({
  selector: 'app-type-employe-list-societe',
  templateUrl: './type-employe-list-societe.component.html',
  styleUrls: ['./type-employe-list-societe.component.css']
})
export class TypeEmployeListSocieteComponent implements OnInit {
   // declarations
