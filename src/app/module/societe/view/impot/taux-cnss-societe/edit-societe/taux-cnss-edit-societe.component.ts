...
@Component({
  selector: 'app-taux-cnss-edit-societe',
  templateUrl: './taux-cnss-edit-societe.component.html',
  styleUrls: ['./taux-cnss-edit-societe.component.css']
})
export class TauxCnssEditSocieteComponent implements OnInit {
