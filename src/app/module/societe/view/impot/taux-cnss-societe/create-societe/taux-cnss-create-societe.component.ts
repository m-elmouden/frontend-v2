...
@Component({
  selector: 'app-taux-cnss-create-societe',
  templateUrl: './taux-cnss-create-societe.component.html',
  styleUrls: ['./taux-cnss-create-societe.component.css']
})
export class TauxCnssCreateSocieteComponent implements OnInit {
