...
@Component({
  selector: 'app-paiement-declaration-ir-view-societe',
  templateUrl: './paiement-declaration-ir-view-societe.component.html',
  styleUrls: ['./paiement-declaration-ir-view-societe.component.css']
})
export class PaiementDeclarationIrViewSocieteComponent implements OnInit {
