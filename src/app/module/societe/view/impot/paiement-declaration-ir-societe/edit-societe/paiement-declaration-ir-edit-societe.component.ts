...
@Component({
  selector: 'app-paiement-declaration-ir-edit-societe',
  templateUrl: './paiement-declaration-ir-edit-societe.component.html',
  styleUrls: ['./paiement-declaration-ir-edit-societe.component.css']
})
export class PaiementDeclarationIrEditSocieteComponent implements OnInit {
