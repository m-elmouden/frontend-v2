...
@Component({
  selector: 'app-paiement-declaration-ir-create-societe',
  templateUrl: './paiement-declaration-ir-create-societe.component.html',
  styleUrls: ['./paiement-declaration-ir-create-societe.component.css']
})
export class PaiementDeclarationIrCreateSocieteComponent implements OnInit {
