...
@Component({
  selector: 'app-cpc-facture-list-societe',
  templateUrl: './cpc-facture-list-societe.component.html',
  styleUrls: ['./cpc-facture-list-societe.component.css']
})
export class CpcFactureListSocieteComponent implements OnInit {
   // declarations
