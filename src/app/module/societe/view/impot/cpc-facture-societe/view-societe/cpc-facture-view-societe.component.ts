...
@Component({
  selector: 'app-cpc-facture-view-societe',
  templateUrl: './cpc-facture-view-societe.component.html',
  styleUrls: ['./cpc-facture-view-societe.component.css']
})
export class CpcFactureViewSocieteComponent implements OnInit {
