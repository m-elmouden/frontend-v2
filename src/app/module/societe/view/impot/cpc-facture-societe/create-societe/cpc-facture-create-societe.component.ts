...
@Component({
  selector: 'app-cpc-facture-create-societe',
  templateUrl: './cpc-facture-create-societe.component.html',
  styleUrls: ['./cpc-facture-create-societe.component.css']
})
export class CpcFactureCreateSocieteComponent implements OnInit {
