...
@Component({
  selector: 'app-cpc-facture-edit-societe',
  templateUrl: './cpc-facture-edit-societe.component.html',
  styleUrls: ['./cpc-facture-edit-societe.component.css']
})
export class CpcFactureEditSocieteComponent implements OnInit {
