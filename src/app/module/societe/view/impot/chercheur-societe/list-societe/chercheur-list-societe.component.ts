...
@Component({
  selector: 'app-chercheur-list-societe',
  templateUrl: './chercheur-list-societe.component.html',
  styleUrls: ['./chercheur-list-societe.component.css']
})
export class ChercheurListSocieteComponent implements OnInit {
   // declarations
