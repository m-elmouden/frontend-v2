...
@Component({
  selector: 'app-chercheur-edit-societe',
  templateUrl: './chercheur-edit-societe.component.html',
  styleUrls: ['./chercheur-edit-societe.component.css']
})
export class ChercheurEditSocieteComponent implements OnInit {
