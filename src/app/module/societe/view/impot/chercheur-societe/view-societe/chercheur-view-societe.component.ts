...
@Component({
  selector: 'app-chercheur-view-societe',
  templateUrl: './chercheur-view-societe.component.html',
  styleUrls: ['./chercheur-view-societe.component.css']
})
export class ChercheurViewSocieteComponent implements OnInit {
