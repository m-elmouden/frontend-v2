...
@Component({
  selector: 'app-chercheur-create-societe',
  templateUrl: './chercheur-create-societe.component.html',
  styleUrls: ['./chercheur-create-societe.component.css']
})
export class ChercheurCreateSocieteComponent implements OnInit {
