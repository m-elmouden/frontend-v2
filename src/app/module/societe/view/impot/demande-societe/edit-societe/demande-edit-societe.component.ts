...
@Component({
  selector: 'app-demande-edit-societe',
  templateUrl: './demande-edit-societe.component.html',
  styleUrls: ['./demande-edit-societe.component.css']
})
export class DemandeEditSocieteComponent implements OnInit {
