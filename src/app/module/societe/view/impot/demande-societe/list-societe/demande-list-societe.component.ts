...
@Component({
  selector: 'app-demande-list-societe',
  templateUrl: './demande-list-societe.component.html',
  styleUrls: ['./demande-list-societe.component.css']
})
export class DemandeListSocieteComponent implements OnInit {
   // declarations
