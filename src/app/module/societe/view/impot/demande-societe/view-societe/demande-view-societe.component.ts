...
@Component({
  selector: 'app-demande-view-societe',
  templateUrl: './demande-view-societe.component.html',
  styleUrls: ['./demande-view-societe.component.css']
})
export class DemandeViewSocieteComponent implements OnInit {
