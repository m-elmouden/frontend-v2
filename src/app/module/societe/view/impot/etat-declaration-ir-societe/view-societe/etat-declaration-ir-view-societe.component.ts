...
@Component({
  selector: 'app-etat-declaration-ir-view-societe',
  templateUrl: './etat-declaration-ir-view-societe.component.html',
  styleUrls: ['./etat-declaration-ir-view-societe.component.css']
})
export class EtatDeclarationIrViewSocieteComponent implements OnInit {
