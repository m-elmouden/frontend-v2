...
@Component({
  selector: 'app-etat-declaration-ir-list-societe',
  templateUrl: './etat-declaration-ir-list-societe.component.html',
  styleUrls: ['./etat-declaration-ir-list-societe.component.css']
})
export class EtatDeclarationIrListSocieteComponent implements OnInit {
   // declarations
