...
@Component({
  selector: 'app-etat-declaration-ir-edit-societe',
  templateUrl: './etat-declaration-ir-edit-societe.component.html',
  styleUrls: ['./etat-declaration-ir-edit-societe.component.css']
})
export class EtatDeclarationIrEditSocieteComponent implements OnInit {
