...
@Component({
  selector: 'app-etat-declaration-ir-create-societe',
  templateUrl: './etat-declaration-ir-create-societe.component.html',
  styleUrls: ['./etat-declaration-ir-create-societe.component.css']
})
export class EtatDeclarationIrCreateSocieteComponent implements OnInit {
