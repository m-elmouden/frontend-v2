...
@Component({
  selector: 'app-prelevement-social-employe-create-societe',
  templateUrl: './prelevement-social-employe-create-societe.component.html',
  styleUrls: ['./prelevement-social-employe-create-societe.component.css']
})
export class PrelevementSocialEmployeCreateSocieteComponent implements OnInit {
