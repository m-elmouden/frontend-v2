...
@Component({
  selector: 'app-prelevement-social-employe-view-societe',
  templateUrl: './prelevement-social-employe-view-societe.component.html',
  styleUrls: ['./prelevement-social-employe-view-societe.component.css']
})
export class PrelevementSocialEmployeViewSocieteComponent implements OnInit {
