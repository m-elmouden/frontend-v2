...
@Component({
  selector: 'app-prelevement-social-employe-edit-societe',
  templateUrl: './prelevement-social-employe-edit-societe.component.html',
  styleUrls: ['./prelevement-social-employe-edit-societe.component.css']
})
export class PrelevementSocialEmployeEditSocieteComponent implements OnInit {
