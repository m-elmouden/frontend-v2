...
@Component({
  selector: 'app-declaration-ir-view-societe',
  templateUrl: './declaration-ir-view-societe.component.html',
  styleUrls: ['./declaration-ir-view-societe.component.css']
})
export class DeclarationIrViewSocieteComponent implements OnInit {
