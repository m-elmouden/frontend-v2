...
@Component({
  selector: 'app-declaration-ir-list-societe',
  templateUrl: './declaration-ir-list-societe.component.html',
  styleUrls: ['./declaration-ir-list-societe.component.css']
})
export class DeclarationIrListSocieteComponent implements OnInit {
   // declarations
