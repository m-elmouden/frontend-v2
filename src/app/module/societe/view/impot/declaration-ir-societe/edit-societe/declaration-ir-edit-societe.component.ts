...
@Component({
  selector: 'app-declaration-ir-edit-societe',
  templateUrl: './declaration-ir-edit-societe.component.html',
  styleUrls: ['./declaration-ir-edit-societe.component.css']
})
export class DeclarationIrEditSocieteComponent implements OnInit {
