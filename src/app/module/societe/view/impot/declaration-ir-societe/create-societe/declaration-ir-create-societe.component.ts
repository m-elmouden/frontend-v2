...
@Component({
  selector: 'app-declaration-ir-create-societe',
  templateUrl: './declaration-ir-create-societe.component.html',
  styleUrls: ['./declaration-ir-create-societe.component.css']
})
export class DeclarationIrCreateSocieteComponent implements OnInit {
