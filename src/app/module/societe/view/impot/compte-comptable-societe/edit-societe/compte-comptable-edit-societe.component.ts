...
@Component({
  selector: 'app-compte-comptable-edit-societe',
  templateUrl: './compte-comptable-edit-societe.component.html',
  styleUrls: ['./compte-comptable-edit-societe.component.css']
})
export class CompteComptableEditSocieteComponent implements OnInit {
