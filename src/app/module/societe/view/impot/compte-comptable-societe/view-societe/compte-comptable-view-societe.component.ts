...
@Component({
  selector: 'app-compte-comptable-view-societe',
  templateUrl: './compte-comptable-view-societe.component.html',
  styleUrls: ['./compte-comptable-view-societe.component.css']
})
export class CompteComptableViewSocieteComponent implements OnInit {
