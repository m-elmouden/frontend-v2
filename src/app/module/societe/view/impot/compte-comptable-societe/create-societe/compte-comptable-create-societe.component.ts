...
@Component({
  selector: 'app-compte-comptable-create-societe',
  templateUrl: './compte-comptable-create-societe.component.html',
  styleUrls: ['./compte-comptable-create-societe.component.css']
})
export class CompteComptableCreateSocieteComponent implements OnInit {
