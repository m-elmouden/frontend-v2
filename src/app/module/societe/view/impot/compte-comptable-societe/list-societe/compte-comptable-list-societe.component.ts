...
@Component({
  selector: 'app-compte-comptable-list-societe',
  templateUrl: './compte-comptable-list-societe.component.html',
  styleUrls: ['./compte-comptable-list-societe.component.css']
})
export class CompteComptableListSocieteComponent implements OnInit {
   // declarations
