...
@Component({
  selector: 'app-paiement-declaration-is-create-societe',
  templateUrl: './paiement-declaration-is-create-societe.component.html',
  styleUrls: ['./paiement-declaration-is-create-societe.component.css']
})
export class PaiementDeclarationIsCreateSocieteComponent implements OnInit {
