...
@Component({
  selector: 'app-paiement-declaration-is-list-societe',
  templateUrl: './paiement-declaration-is-list-societe.component.html',
  styleUrls: ['./paiement-declaration-is-list-societe.component.css']
})
export class PaiementDeclarationIsListSocieteComponent implements OnInit {
   // declarations
