...
@Component({
  selector: 'app-paiement-declaration-is-view-societe',
  templateUrl: './paiement-declaration-is-view-societe.component.html',
  styleUrls: ['./paiement-declaration-is-view-societe.component.css']
})
export class PaiementDeclarationIsViewSocieteComponent implements OnInit {
