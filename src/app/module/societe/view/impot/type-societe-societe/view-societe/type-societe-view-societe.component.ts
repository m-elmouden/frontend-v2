...
@Component({
  selector: 'app-type-societe-view-societe',
  templateUrl: './type-societe-view-societe.component.html',
  styleUrls: ['./type-societe-view-societe.component.css']
})
export class TypeSocieteViewSocieteComponent implements OnInit {
