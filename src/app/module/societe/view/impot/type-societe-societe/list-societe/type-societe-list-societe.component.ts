...
@Component({
  selector: 'app-type-societe-list-societe',
  templateUrl: './type-societe-list-societe.component.html',
  styleUrls: ['./type-societe-list-societe.component.css']
})
export class TypeSocieteListSocieteComponent implements OnInit {
   // declarations
