...
@Component({
  selector: 'app-type-societe-edit-societe',
  templateUrl: './type-societe-edit-societe.component.html',
  styleUrls: ['./type-societe-edit-societe.component.css']
})
export class TypeSocieteEditSocieteComponent implements OnInit {
