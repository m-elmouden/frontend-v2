...
@Component({
  selector: 'app-type-societe-create-societe',
  templateUrl: './type-societe-create-societe.component.html',
  styleUrls: ['./type-societe-create-societe.component.css']
})
export class TypeSocieteCreateSocieteComponent implements OnInit {
