...
@Component({
  selector: 'app-etat-demande-edit-societe',
  templateUrl: './etat-demande-edit-societe.component.html',
  styleUrls: ['./etat-demande-edit-societe.component.css']
})
export class EtatDemandeEditSocieteComponent implements OnInit {
