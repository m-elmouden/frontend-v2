...
@Component({
  selector: 'app-etat-demande-list-societe',
  templateUrl: './etat-demande-list-societe.component.html',
  styleUrls: ['./etat-demande-list-societe.component.css']
})
export class EtatDemandeListSocieteComponent implements OnInit {
   // declarations
