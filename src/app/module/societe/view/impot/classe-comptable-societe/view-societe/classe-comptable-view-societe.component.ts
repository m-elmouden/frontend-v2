...
@Component({
  selector: 'app-classe-comptable-view-societe',
  templateUrl: './classe-comptable-view-societe.component.html',
  styleUrls: ['./classe-comptable-view-societe.component.css']
})
export class ClasseComptableViewSocieteComponent implements OnInit {
