...
@Component({
  selector: 'app-classe-comptable-edit-societe',
  templateUrl: './classe-comptable-edit-societe.component.html',
  styleUrls: ['./classe-comptable-edit-societe.component.css']
})
export class ClasseComptableEditSocieteComponent implements OnInit {
