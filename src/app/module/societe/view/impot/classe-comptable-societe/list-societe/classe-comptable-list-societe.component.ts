...
@Component({
  selector: 'app-classe-comptable-list-societe',
  templateUrl: './classe-comptable-list-societe.component.html',
  styleUrls: ['./classe-comptable-list-societe.component.css']
})
export class ClasseComptableListSocieteComponent implements OnInit {
   // declarations
