...
export class DeclarationIrService {
    ...
    listDeclaration: Observable<Array<DeclarationIrVo>>;
...
// methods
    ...
    public save(): Observable<DeclarationIrVo> {
        ...
        return this.http.post<DeclarationIrVo>(this.API, {
            ...this.selectedDeclarationIr,
            dateCreation: moment(this.selectedDeclarationIr.dateCreation).format('YYYY-MM-DD')
        });
    }
    ...
    public findByEtatDeclarationIrReference(reference: string): Observable<Array<DeclarationIrVo>> {
        this.listDeclaration = this.http.get<Array<DeclarationIrVo>>(this.API + 'etatDeclarationIr/reference/' + reference);
